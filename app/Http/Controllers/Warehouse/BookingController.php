...
class BookingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            'haulier' => 'nullable|string|max:255',
        ...
        // Custom validation: Ensure at least one PO line has cases > 0 (only if PO data required)
