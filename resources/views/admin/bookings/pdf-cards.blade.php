                ...
                <div class="card-inner">
                        ...
                        <div class="load-comparison">
                            <div class="load-row">
                                <div class="load-expected">
                                    <strong>Cases:</strong><br>{{ number_format($booking->total_expected_cases ?? 0) }}
                                </div>
                                @if($booking->total_actual_cases)
                                    <div class="load-arrow">→</div>
                                    <div class="load-actual">
                                        <strong>Actual:</strong><br>{{ number_format($booking->total_actual_cases) }}
                    ...
                    @if($booking->total_expected_pallets || $booking->total_actual_pallets)
                        <div class="load-comparison">
                            <div class="load-row">
                                <div class="load-expected">
                                    <strong>Pallets:</strong><br>{{ number_format($booking->total_expected_pallets ?? 0) }}
                                </div>
                                @if($booking->total_actual_pallets)
                                    <div class="load-arrow">→</div>
                                    <div class="load-actual">
                                        <strong>Actual:</strong><br>{{ number_format($booking->total_actual_pallets) }}
