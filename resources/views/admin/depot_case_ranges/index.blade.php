...
<div class="p-6 bg-white rounded shadow">
  ...
  <a href="{{ route('app.depots.case-ranges.create', $depot) }}" class="btn">Add Range</a>
  <table class="mt-4 w-full">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>
          <a href="{{ route('app.depots.case-ranges.edit', [$depot,$r]) }}" class="link">Edit</a>
          <form action="{{ route('app.depots.case-ranges.destroy', [$depot,$r]) }}" method="POST" class="inline">
            @csrf @method('DELETE')
