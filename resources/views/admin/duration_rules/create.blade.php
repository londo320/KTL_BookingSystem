...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    ...
    <form action="{{ route('app.duration-rules.store') }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="bg-white shadow rounded-lg p-6 space-y-4">
            ...
            <div>
                ...
                <select name="booking_type_id" required
                    ...
                    @foreach($bookingTypes as $type)
                        <option value="{{ $type->id }}" @selected(old('booking_type_id') == $type->id)>
                            {{ $type->name }}
                        </option>
                    @endforeach
                </select>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="min_cases" value="{{ old('min_cases', 0) }}" required
                           min="0" step="1"
                           class="block w-full border-gray-300 rounded text-sm py-2">
                ...
                <div>
                    ...
                    <input type="number" name="max_cases" value="{{ old('max_cases') }}"
                           min="0" step="1"
                           class="block w-full border-gray-300 rounded text-sm py-2">
            ...
            <div>
                ...
                <input type="number" name="duration_minutes" value="{{ old('duration_minutes', 180) }}" required
