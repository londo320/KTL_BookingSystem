...
@section('title', 'Register Driver Arrival')
...
<div class="py-8">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <form action="{{ route('outbound.arrivals.store') }}" method="POST" class="space-y-8">
            @csrf
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="load_reference" id="load_reference" 
                                   value="{{ old('load_reference') }}"
                                   class="form-input w-full rounded-md @error('load_reference') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input type="text" name="driver_paperwork_ref" id="driver_paperwork_ref" 
                                   value="{{ old('driver_paperwork_ref') }}"
                                   class="form-input w-full rounded-md @error('driver_paperwork_ref') border-red-500 @enderror"
                                   placeholder="Consignment note number">
                            @error('driver_paperwork_ref')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="number" name="expected_orders" id="expected_orders" 
                               value="{{ old('expected_orders') }}"
                               class="form-input w-full rounded-md @error('expected_orders') border-red-500 @enderror"
                               placeholder="5" min="0" max="1000">
                        @error('expected_orders')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                        <p class="text-sm text-gray-500 mt-1">
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="vehicle_registration" id="vehicle_registration" 
                                   ...
                                   class="form-input w-full rounded-md @error('vehicle_registration') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input type="text" name="trailer_registration" id="trailer_registration" 
                                   ...
                                   class="form-input w-full rounded-md @error('trailer_registration') border-red-500 @enderror"
                    ...
                    <div>
                        ...
                        <input type="text" name="carrier_company" id="carrier_company" 
                               ...
                               class="form-input w-full rounded-md @error('carrier_company') border-red-500 @enderror"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        <div>
                            ...
                            <input type="text" name="driver_name" id="driver_name" 
                                   ...
                                   class="form-input w-full rounded-md @error('driver_name') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input type="tel" name="driver_phone" id="driver_phone" 
                                   ...
                                   class="form-input w-full rounded-md @error('driver_phone') border-red-500 @enderror"
                        ...
                        <div>
                            ...
                            <input type="text" name="driver_license" id="driver_license" 
                                   ...
                                   class="form-input w-full rounded-md @error('driver_license') border-red-500 @enderror"
                ...
                <div class="p-6 space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="arrival_depot_id" id="arrival_depot_id" 
                                    class="form-select w-full rounded-md @error('arrival_depot_id') border-red-500 @enderror" required>
                                <option value="">Select Depot</option>
                                @foreach($depots as $depot)
                                    <option value="{{ $depot->id }}" {{ old('arrival_depot_id') == $depot->id ? 'selected' : '' }}>
                                        {{ $depot->name }}
                                    </option>
                                @endforeach
                            </select>
                            @error('arrival_depot_id')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div>
                        ...
                        <textarea name="arrival_notes" id="arrival_notes" rows="3"
                                  class="form-textarea w-full rounded-md @error('arrival_notes') border-red-500 @enderror"
                                  placeholder="Any special notes about the arrival or load">{{ old('arrival_notes') }}</textarea>
                        @error('arrival_notes')
                            <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        @enderror
                    </div>
