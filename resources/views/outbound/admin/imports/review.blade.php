...
@section('title', 'Review Import - ' . $fileUpload->original_filename)
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">{{ $fileUpload->original_filename }}</p>
                    </div>
                ...
                <div class="flex space-x-3">
                    <form method="POST" action="{{ route('outbound.imports.reject', $fileUpload) }}" class="inline">
                        @csrf
                        <button type="submit" 
                    ...
                    <form method="POST" action="{{ route('outbound.imports.approve', $fileUpload) }}" class="inline">
                        @csrf
                        <button type="submit" 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div class="lg:col-span-2 space-y-8">
                            ...
                            <div class="overflow-x-auto">
                                <table class="min-w-full divide-y divide-gray-200">
                                    ...
                                    <tbody class="bg-white divide-y divide-gray-200">
                                        @foreach(array_slice($fileUpload->preview_data, 0, 10) as $row)
                                ...
                                @if(count($fileUpload->preview_data) > 10)
                                    <div class="px-6 py-4 bg-gray-50 border-t border-gray-200">
                                        <p class="text-sm text-gray-600 text-center">
                                            Showing first 10 rows of {{ count($fileUpload->preview_data) }} total rows
                                        </p>
                                    </div>
                                @endif
                            </div>
                ...
                <!-- Validation Results -->
                @if($fileUpload->validation_errors)
                    <div class="bg-white rounded-lg shadow">
                        <div class="px-6 py-4 border-b border-gray-200">
                                    ...
                                    <div class="ml-3">
                                        ...
                                        <div class="mt-2 text-sm text-yellow-700">
                                            <ul class="list-disc list-inside space-y-1">
                                                @foreach($fileUpload->validation_errors as $error)
                                                    <li>{{ $error }}</li>
                                                @endforeach
                                            </ul>
                                        </div>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 space-y-4">
                        <div>
                            ...
                            <dd class="text-sm text-gray-900">{{ $fileUpload->original_filename }}</dd>
                        </div>
                        <div>
                        ...
                        @if($fileUpload->total_rows)
                            <div>
                                ...
                                <dd class="text-sm text-gray-900">{{ number_format($fileUpload->total_rows) }}</dd>
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="p-6 space-y-4">
                        ...
                        @if($fileUpload->importTemplate->description)
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Description</dt>
                                <dd class="text-sm text-gray-900">{{ $fileUpload->importTemplate->description }}</dd>
                            </div>
                        @endif
                    </div>
                </div>
