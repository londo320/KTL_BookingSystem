  ...
  <div class="flex justify-between items-center px-6 py-3">
    ...
    <li>
      ...
      <a href="{{ route($depotMapPrefix . 'depot-map.index') }}"
         class="px-3 py-1 rounded {{ request()->routeIs('admin.depot-map.*', 'depot.depot-map.*') ? 'bg-green-500 text-white' : 'text-gray-700 dark:text-gray-300' }}">
        🗺️ Depot Map
      </a>
    </li>
    <li class="relative">
      ...
      <div id="tipping-dropdown" class="absolute left-0 mt-2 w-48 bg-white border border-gray-200 rounded-md shadow-lg z-20 hidden">
        ...
        <a href="{{ route($mapRoutePrefix . 'depot-map.index') }}" 
           class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 {{ request()->routeIs('admin.depot-map.*', 'depot.depot-map.*') ? 'bg-orange-50 text-orange-600' : '' }}">
          🗺️ Depot Map
        </a>
