    ...
    <div class="mb-6 p-6 bg-blue-50 border border-blue-200 rounded-lg">
      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div>
          ...
          <p class="font-medium">
            <?php echo e($actualRebookCount ?? $booking->rebook_count ?? 0); ?> / 3
        ...
        <div class="flex justify-between items-center">
          ...
          <div class="flex items-center space-x-2">
            ...
            <div class="flex bg-gray-100 rounded-lg p-1">
              <a href="<?php echo e(route('admin.bookings.history', $booking)); ?>?sort=asc" 
                 class="px-3 py-1 text-xs rounded-md <?php echo e($sortOrder === 'asc' ? 'bg-blue-500 text-white' : 'text-gray-600 hover:text-gray-800'); ?>">
                📈 Oldest First
              </a>
              <a href="<?php echo e(route('admin.bookings.history', $booking)); ?>?sort=desc" 
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <?php if($booking->tipping_completed_at): ?>
                <div class="text-center p-3 bg-purple-50 rounded-lg border">
                  ...
                  <?php if($booking->tipping_started_at): ?>
                    <div class="text-xs text-gray-500">Duration: <?php echo e($booking->tipping_started_at->diffInMinutes($booking->tipping_completed_at)); ?>min</div>
                  <?php endif; ?>
              ...
              <?php if($booking->departed_at): ?>
                <div class="text-center p-3 bg-gray-50 rounded-lg border">
                  ...
                  <?php if($booking->arrived_at): ?>
                    <div class="text-xs text-gray-500">Total time: <?php echo e($booking->arrived_at->diffInMinutes($booking->departed_at)); ?>min</div>
                  <?php endif; ?>
                </div>
              <?php elseif($booking->isCancelled()): ?>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/bookings/history.blade.php ENDPATH**/ ?>