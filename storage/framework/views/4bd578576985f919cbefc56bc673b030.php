...
<?php $component->withAttributes([]); ?>
  ...
  <div class="py-6 max-w-3xl mx-auto bg-white p-6 rounded shadow">
    <form action="<?php echo e(route('admin.bookings.update', $booking)); ?>" method="POST">
      <?php echo csrf_field(); ?>
          ...
          <div class="ml-3 flex-1">
            ...
            <div class="bg-white rounded border border-yellow-300 p-4">
              ...
              <div class="text-sm text-gray-600 space-y-1">
                ...
                <?php if($booking->waiting_area_location): ?>
                  <div><strong>Waiting Area:</strong> <?php echo e($booking->waiting_area_location); ?></div>
                <?php endif; ?>
            ...
            <div class="mt-4 flex items-center justify-between">
              ...
              <form method="POST" action="<?php echo e(request()->route()->getPrefix() === 'depot-admin' 
                  ...
                  : route('admin.bookings.unbook', $booking)); ?>" class="inline">
                <?php echo csrf_field(); ?>
                <button type="submit" 
    ...
    document.getElementById('cancelForm').addEventListener('submit', function(e) {
      ...
      .then(data => {
        if (data.success) {
          ...
          window.location.href = '<?php echo e(route("admin.bookings.show", $booking)); ?>';
        } else {
...
<?php endif; ?>
<?php /**PATH /Users/londo/Herd/test/resources/views/admin/bookings/edit.blade.php ENDPATH**/ ?>