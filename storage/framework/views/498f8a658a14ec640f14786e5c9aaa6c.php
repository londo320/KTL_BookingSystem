...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('app.duration-rules.create')); ?>"
                ...
                <?php $__empty_1 = true; $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-4 py-3 text-sm">
                            <?php echo e(number_format($rule->min_cases)); ?> -
                            <?php if($rule->max_cases): ?>
                                <?php echo e(number_format($rule->max_cases)); ?>
                        ...
                        <td class="px-4 py-3">
                            <span class="font-semibold text-lg"><?php echo e($rule->duration_minutes); ?></span>
                            <span class="text-sm text-gray-500">mins</span>
                            <span class="text-xs text-gray-400">(<?php echo e(round($rule->duration_minutes / 60, 1)); ?>h)</span>
                        </td>
                        <td class="px-4 py-3 text-sm">
                            <?php if($rule->depot): ?>
                                <?php echo e($rule->depot->name); ?>
                        ...
                        <td class="px-4 py-3 text-sm">
                            <?php if($rule->customer): ?>
                                <?php echo e($rule->customer->name); ?>
                        ...
                        <td class="px-4 py-3 space-x-2">
                            <a href="<?php echo e(route('app.duration-rules.edit', $rule)); ?>"
                               class="text-blue-600 hover:underline text-sm">Edit</a>
                            <form action="<?php echo e(route('app.duration-rules.destroy', $rule)); ?>"
                                  method="POST"
                                  class="inline-block"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/duration_rules/index.blade.php ENDPATH**/ ?>