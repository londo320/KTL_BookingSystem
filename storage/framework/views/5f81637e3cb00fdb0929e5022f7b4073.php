     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                <?php if($canTakeAction): ?>
                    <a href="<?php echo e(route('admin.tipping-bays.edit', $tippingBay)); ?>" 
        ...
        <?php if($currentBooking): ?>
            <div class="mb-6 bg-white rounded-lg shadow overflow-hidden">
                ...
                <div class="p-6">
                    ...
                    <div class="flex space-x-2">
                        <a href="<?php echo e(route('admin.bookings.show', $currentBooking)); ?>" 
                           class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600">
                            View Booking Details
                        </a>
                        <a href="<?php echo e(route('admin.tipping-workflow.show', $currentBooking)); ?>" 
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/tipping-bays/show.blade.php ENDPATH**/ ?>