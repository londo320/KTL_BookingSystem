...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Create Duration Rule</h1>
        <p class="text-gray-600 mt-1">Set booking duration based on case count</p>
    </div>

    <form action="<?php echo e(route('app.duration-rules.store')); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
            ...
            <div>
                ...
                <select name="booking_type_id" required
                    ...
                    <?php $__currentLoopData = $bookingTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($type->id); ?>" <?php if(old('booking_type_id') == $type->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" name="min_cases" value="<?php echo e(old('min_cases', 0)); ?>" required
                           min="0" step="1"
                           class="block w-full border-gray-300 rounded text-sm py-2">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="number" name="max_cases" value="<?php echo e(old('max_cases')); ?>"
                           min="0" step="1"
                           class="block w-full border-gray-300 rounded text-sm py-2">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="duration_minutes" value="<?php echo e(old('duration_minutes', 180)); ?>" required
            ...
            <div>
                ...
                <select name="depot_id" class="block w-full border-gray-300 rounded text-sm py-2">
                    ...
                    <?php $__currentLoopData = $depots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($depot->id); ?>" <?php if(old('depot_id') == $depot->id): echo 'selected'; endif; ?>>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="priority" value="<?php echo e(old('priority', 0)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="p-4 bg-yellow-50 border border-yellow-200 rounded">
                <p class="text-sm font-medium text-yellow-900 mb-2">💡 Example Configuration:</p>
                <ul class="text-xs text-yellow-800 space-y-1">
                    <li><strong>Rule 1:</strong> Handball, 0-5000 cases, 180 mins (3 hours)</li>
                    <li><strong>Rule 2:</strong> Handball, 5001+ cases, 240 mins (4 hours)</li>
                    <li><strong>Result:</strong> Small loads = 3 hours, large loads = 4 hours</li>
                </ul>
            </div>
        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/duration_rules/create.blade.php ENDPATH**/ ?>