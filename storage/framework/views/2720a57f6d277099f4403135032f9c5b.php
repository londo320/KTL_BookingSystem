...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <form method="POST" action="<?php echo e(route('admin.tipping-locations.store')); ?>" class="p-6">
                <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select name="location_type" id="location_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                                <option value="drop_zone" <?php echo e(old('location_type', 'drop_zone') == 'drop_zone' ? 'selected' : ''); ?>>Drop Zone</option>
                                <option value="collection_zone" <?php echo e(old('location_type') == 'collection_zone' ? 'selected' : ''); ?>>Collection Zone</option>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/tipping-locations/create.blade.php ENDPATH**/ ?>