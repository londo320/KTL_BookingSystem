                        ...
                        <tr class="hover:bg-gray-50 <?php echo e($rowClass); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <?php if($history->booking): ?>
                                    <a href="<?php echo e(route('app.bookings.show', $history->booking)); ?>" 
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/customer-behavior/show.blade.php ENDPATH**/ ?>