...
<?php $component->withAttributes([]); ?>
  ...
  <div class="py-6 max-w-2xl mx-auto">
    <div class="bg-white p-6 rounded-lg shadow">
      <form method="POST" action="<?php echo e(route('app.settings.pallet-types.store')); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/pallet-types/create.blade.php ENDPATH**/ ?>