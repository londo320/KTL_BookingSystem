...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1"><?php echo e($tippingBay->name); ?> - <?php echo e($tippingBay->depot->name); ?></p>
            </div>
            <div class="flex space-x-2">
                <a href="<?php echo e(route('app.tipping-bays.show', $tippingBay)); ?>" 
    ...
    <div class="py-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <form method="POST" action="<?php echo e(route('app.tipping-bays.update', $tippingBay)); ?>" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <select name="depot_id" id="depot_id" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                                ...
                                <?php $__currentLoopData = $depots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($depot->id); ?>" <?php echo e((old('depot_id', $tippingBay->depot_id) == $depot->id) ? 'selected' : ''); ?>>
                        ...
                        <div>
                            ...
                            <input type="text" name="name" id="name" value="<?php echo e(old('name', $tippingBay->name)); ?>" 
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="code" id="code" value="<?php echo e(old('code', $tippingBay->code)); ?>" 
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                        ...
                        <div class="space-y-4">
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="is_active" id="is_active" value="1" 
                                       <?php echo e(old('is_active', $tippingBay->is_active) ? 'checked' : ''); ?>
                            ...
                            <p class="text-xs text-gray-500">
                                ...
                                <?php if($tippingBay->currentBooking()): ?>
                            ...
                            <div class="flex items-center">
                                ...
                                <input type="checkbox" name="show_on_map" id="show_on_map" value="1" 
                                       <?php echo e(old('show_on_map', $tippingBay->show_on_map) ? 'checked' : ''); ?>
                    ...
                    <div>
                        ...
                        <textarea name="description" id="description" rows="3" 
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                  placeholder="Additional details about this bay..."><?php echo e(old('description', $tippingBay->description)); ?></textarea>
                    </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input type="number" name="map_x" id="map_x" 
                                       value="<?php echo e(old('map_x', $tippingBay->map_x)); ?>" 
                            ...
                            <div>
                                ...
                                <input type="number" name="map_y" id="map_y" 
                                       value="<?php echo e(old('map_y', $tippingBay->map_y)); ?>" 
                                       min="0" max="100" step="0.1"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                                <div>
                                    ...
                                    <input type="number" name="map_width" id="map_width" 
                                           value="<?php echo e(old('map_width', $tippingBay->map_width ?? 60)); ?>" 
                                           min="20" max="300"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           placeholder="60">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="map_height" id="map_height" 
                                           value="<?php echo e(old('map_height', $tippingBay->map_height ?? 40)); ?>" 
                                           min="15" max="200"
                                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" 
                                           placeholder="40">
                                </div>
                                <div>
                                    ...
                                    <input type="number" name="map_rotation" id="map_rotation" 
                                           value="<?php echo e(old('map_rotation', $tippingBay->map_rotation ?? 0)); ?>" 
                                ...
                                <div>
                                    ...
                                    <select name="text_size" id="text_size" 
                                            class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                                        <option value="xs" <?php echo e(old('text_size', $tippingBay->text_size ?? 'xs') === 'xs' ? 'selected' : ''); ?>>Extra Small</option>
                                        <option value="sm" <?php echo e(old('text_size', $tippingBay->text_size ?? 'xs') === 'sm' ? 'selected' : ''); ?>>Small</option>
                                        <option value="md" <?php echo e(old('text_size', $tippingBay->text_size ?? 'xs') === 'md' ? 'selected' : ''); ?>>Medium</option>
                                        <option value="lg" <?php echo e(old('text_size', $tippingBay->text_size ?? 'xs') === 'lg' ? 'selected' : ''); ?>>Large</option>
                                    </select>
                                </div>
                            </div>
                            <div class="mt-4">
                                ...
                                <div class="flex items-center space-x-3">
                                    <input type="color" name="text_color" id="text_color" 
                                           value="<?php echo e(old('text_color', $tippingBay->text_color ?? '#ffffff')); ?>" 
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <ul class="mt-2 text-sm text-blue-700 space-y-1">
                                        ...
                                        <li>• Use the <a href="<?php echo e(route('app.depot-map.manage-positions', $tippingBay->depot)); ?>" class="underline hover:no-underline">Interactive Map Editor</a> for drag-and-drop positioning and real-time styling</li>
                    ...
                    <div>
                        ...
                        <div id="equipment-container">
                            ...
                            ?>
                            <?php if($equipmentData && count($equipmentData) > 0): ?>
                                <?php $__currentLoopData = $equipmentData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $equipment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($equipment): ?>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/tipping-bays/edit.blade.php ENDPATH**/ ?>