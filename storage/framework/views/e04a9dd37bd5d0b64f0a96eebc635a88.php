...
<div class="container mx-auto px-4 py-6 max-w-3xl">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-gray-900">Create Bay Capacity Rule</h1>
        <p class="text-gray-600 mt-1">Set maximum concurrent bookings for a booking type at a depot</p>
    </div>

    <form action="<?php echo e(route('app.bay-capacity-rules.store')); ?>" method="POST" class="space-y-6">
        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="time" name="time_start" value="<?php echo e(old('time_start', '08:00')); ?>" required
                           class="block w-full border-gray-300 rounded text-sm py-2">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="time" name="time_end" value="<?php echo e(old('time_end', '17:00')); ?>" required
                           class="block w-full border-gray-300 rounded text-sm py-2">
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <?php $__currentLoopData = ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday', 'Saturday', 'Sunday']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $day): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center text-sm">
                            <input type="checkbox" name="days_of_week[]" value="<?php echo e($day); ?>"
                                   <?php if(in_array($day, old('days_of_week', []))): echo 'checked'; endif; ?>
                                   class="mr-1">
            ...
            <div>
                ...
                <input type="number" name="max_concurrent_bookings" value="<?php echo e(old('max_concurrent_bookings', 3)); ?>"
...
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="number" name="capacity_weight" value="<?php echo e(old('capacity_weight', 1.0)); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/bay_capacity_rules/create.blade.php ENDPATH**/ ?>