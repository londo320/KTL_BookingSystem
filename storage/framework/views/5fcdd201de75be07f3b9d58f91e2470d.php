...
<div class="welcome-message">Welcome <?php echo e($user->name); ?>!</div>
...
<div class="access-details">
    ...
    <div class="detail-row">
        ...
        <span class="detail-value"><?php echo e(implode(', ', $roles)); ?></span>
    </div>
    <?php endif; ?>
    <?php if($depots && count($depots) > 0): ?>
    <div class="detail-row">
        <span class="detail-label">Depot Access:</span>
        <span class="detail-value"><?php echo e(implode(', ', $depots)); ?></span>
    </div>
    <?php endif; ?>
</div>
...
<?php echo $__env->make('emails.layouts.ktl-layout', ['subject' => 'Access Granted - KTL Booking System'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/emails/access-granted.blade.php ENDPATH**/ ?>