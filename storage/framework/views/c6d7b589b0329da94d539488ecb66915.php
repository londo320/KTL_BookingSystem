...
<?php endif; ?>
        ...
        <?php if($user->email === 'paul.carr@knowleslogistics.com'): ?>
                ...
                <div class="flex items-start justify-between">
                    <div class="flex-1">
                        <h3 class="text-sm font-medium text-gray-900 flex items-center">
                            ...
                            Switch User Feature
                            <?php if($user->switch_user_enabled): ?>
                    ...
                    <div class="ml-4 flex-shrink-0">
                        <label class="relative inline-flex items-center cursor-pointer">
                            ...
                            <input type="checkbox"
                                   ...
                                   value="1"
                                   <?php echo e(old('switch_user_enabled', $user->switch_user_enabled) ? 'checked' : ''); ?>
                            ...
                            <span id="toggle_label" class="ml-3 text-sm font-medium text-gray-900">
                                <?php echo e(old('switch_user_enabled', $user->switch_user_enabled) ? 'Enabled' : 'Disabled'); ?>
