...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                <a href="<?php echo e(route('app.dropped-trailers.index')); ?>" 
    ...
    <div class="py-6 max-w-4xl mx-auto">
                ...
                <div>
                    ...
                    <p class="font-medium">
                        ...
                        <?php elseif($booking->tippingLocation): ?>
                            <?php echo e($booking->tippingLocation->name); ?> (Parking Area)
                        <?php else: ?>
                            Location not set
                        <?php endif; ?>
                    </p>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <form method="POST" action="<?php echo e(route('app.dropped-trailers.reconnect', $booking)); ?>" class="p-6">
                <?php echo csrf_field(); ?>
