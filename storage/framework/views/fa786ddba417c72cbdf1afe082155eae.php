...
<body>
    <div class="container">
        <div class="logo">
            <img src="<?php echo e(asset('images/ktl_logo_email.png')); ?>" alt="KTL Logo">
        </div>
        ...
        <div class="message">
            <h3 style="margin-top: 0; color: #dc2626;">Hello <?php echo e($user->name); ?>!</h3>
            <p>Your account has been created successfully, but access to the system is pending administrator approval.</p>
            
            <div class="status-item">
                <span>Account Created:</span>
                <span class="status-good">✅ <?php echo e($registeredAt->format('d M Y H:i')); ?></span>
            </div>
            <div class="status-item">
                <span>Role Assignment:</span>
                <span class="<?php echo e($hasRoles ? 'status-good' : 'status-pending'); ?>">
                    <?php echo e($hasRoles ? '✅ Assigned' : '⏳ Pending'); ?>

                </span>
            </div>
            <div class="status-item">
                <span>Depot Access:</span>
                <span class="<?php echo e($hasDepots ? 'status-good' : 'status-pending'); ?>">
                    <?php echo e($hasDepots ? '✅ Assigned' : '⏳ Pending'); ?>
...
</html><?php /**PATH /Users/londo/Herd/test/resources/views/pending-access.blade.php ENDPATH**/ ?>