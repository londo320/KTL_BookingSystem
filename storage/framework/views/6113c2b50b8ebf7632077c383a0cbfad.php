...
<?php $component->withAttributes([]); ?>
  ...
  <div class="max-w-5xl mx-auto py-6 space-y-6">
    ...
    <form method="POST" action="<?php echo e(route('admin.depots.products.update', $depot)); ?>">
      <?php echo csrf_field(); ?>
            ...
            <tr class="border-t">
              ...
              <td class="p-2 text-center">
                <?php if(isset($assigned[$product->id])): ?>
                  <form method="POST" action="<?php echo e(route('admin.depots.products.destroy', [$depot, $product])); ?>"
