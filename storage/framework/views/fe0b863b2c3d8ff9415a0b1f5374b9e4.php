                    ...
                    <?php if($data['stats']['factory_bookings']['total'] > 0): ?>
                        <div class="mt-4 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                            <div class="flex items-center justify-between mb-3">
                                ...
                                <a href="<?php echo e(route('app.factory-bookings.index')); ?>?depot_id=<?php echo e($data['depot']->id); ?>" 
                            ...
                            <?php if($data['locations']->isEmpty()): ?>
                                <div class="text-center py-8 text-gray-500">
                                    ...
                                    <?php if(auth()->user()->hasRole('admin')): ?>
                                        <a href="<?php echo e(route('app.tipping-locations.create')); ?>" class="text-blue-600 hover:text-blue-800 mt-2 inline-block">
                                            + Add Drop Location
                                        </a>
                                    <?php endif; ?>
                                </div>
                                                    ...
                                                    <div class="flex items-center justify-between p-2 bg-blue-50 rounded text-sm">
                                                        ...
                                                        <div class="flex items-center space-x-2">
                                                            ...
                                                            <?php if($booking instanceof \App\Models\FactoryBooking): ?>
                                                                <a href="<?php echo e(route('app.factory-booking-workflow.show', $booking)); ?>" 
                        ...
                        <div>
                            ...
                            <?php if($data['bays']->isEmpty()): ?>
                                <div class="text-center py-8 text-gray-500">
                                    ...
                                    <?php if(auth()->user()->hasRole('admin')): ?>
                                        <a href="<?php echo e(route('app.tipping-bays.create')); ?>" class="text-blue-600 hover:text-blue-800 mt-2 inline-block">
                                            + Add Tipping Bay
                                        </a>
                                    <?php endif; ?>
                                </div>
                                            ...
                                            <div class="ml-4 flex flex-col items-end space-y-2">
                                                ...
                                                <?php if($bay->currentBooking): ?>
                                                    <?php if($bay->currentBooking instanceof \App\Models\FactoryBooking): ?>
                                                        <a href="<?php echo e(route('app.factory-booking-workflow.show', $bay->currentBooking)); ?>" 
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/tipping-workflow/dashboard.blade.php ENDPATH**/ ?>