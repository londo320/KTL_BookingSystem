...
<div class="p-6 bg-white rounded-lg shadow">
    ...
    <a href="<?php echo e(route('app.customer-depot-products.create')); ?>"
        ...
        <tbody>
            ...
            <tr class="border-t">
                ...
                <td class="px-4 py-2 text-right">
                    <a href="<?php echo e(route('app.customer-depot-products.edit', $rule)); ?>"
                       class="mr-2 text-blue-600 hover:underline">Edit</a>
                    <form action="<?php echo e(route('app.customer-depot-products.destroy', $rule)); ?>"
