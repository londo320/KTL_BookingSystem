            ...
            <div class="flex">
               ...
               <div class="shrink-0 flex items-center">
                    <a href="<?php echo e(route('dashboard')); ?>">
                        <img
                        src="<?php echo e(asset('images/ktl_logo.svg')); ?>"
                        alt="Knowles Logo"
...
<?php $component->withAttributes(['align' => 'right','width' => '48']); ?>
                     ...
                     <?php $__env->slot('content', null, []); ?> 
                        ...
                        <?php if(!app()->isProduction() && session('original_admin_id')): ?>
                            <form method="POST" action="<?php echo e(route('switch-back')); ?>" class="border-b border-gray-100 pb-1 mb-1">
                                <?php echo csrf_field(); ?>
...
<?php /**PATH /Users/londo/Herd/test/resources/views/layouts/navigation.blade.php ENDPATH**/ ?>