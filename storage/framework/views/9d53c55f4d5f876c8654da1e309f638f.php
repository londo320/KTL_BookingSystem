...
<div class="container mx-auto px-4 py-6">
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="<?php echo e(route('app.bay-capacity-rules.create')); ?>"
            ...
            <tbody class="divide-y divide-gray-200">
                <?php $__empty_1 = true; $__currentLoopData = $rules; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rule): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <tr class="hover:bg-gray-50">
                        <td class="px-4 py-3">
                            <span class="font-medium"><?php echo e($rule->depot->name); ?></span>
                        </td>
                        <td class="px-4 py-3">
                            <?php if($rule->bookingType): ?>
                                <span class="px-2 py-1 bg-blue-100 text-blue-800 rounded text-xs">
                                    <?php echo e($rule->bookingType->name); ?>
                        ...
                        <td class="px-4 py-3 text-sm">
                            <?php echo e(\Carbon\Carbon::parse($rule->time_start)->format('H:i')); ?> -
                            <?php echo e(\Carbon\Carbon::parse($rule->time_end)->format('H:i')); ?>

                        </td>
                        <td class="px-4 py-3 text-sm">
                            <?php if($rule->days_of_week && count($rule->days_of_week) > 0): ?>
                                <span class="text-xs">
                                    <?php echo e(implode(', ', array_map(fn($d) => substr($d, 0, 3), $rule->days_of_week))); ?>
                        ...
                        <td class="px-4 py-3">
                            <span class="font-semibold text-lg"><?php echo e($rule->max_concurrent_bookings); ?></span>
                        </td>
                        <td class="px-4 py-3 text-sm">
                            <?php echo e($rule->capacity_weight); ?>x
                        </td>
                        <td class="px-4 py-3">
                        ...
                        <td class="px-4 py-3 space-x-2">
                            <a href="<?php echo e(route('app.bay-capacity-rules.edit', $rule)); ?>"
                               class="text-blue-600 hover:underline text-sm">Edit</a>
                            <form action="<?php echo e(route('app.bay-capacity-rules.destroy', $rule)); ?>"
                                  method="POST"
                                  class="inline-block"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/bay_capacity_rules/index.blade.php ENDPATH**/ ?>