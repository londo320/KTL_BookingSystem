...
<div class="py-6 max-w-7xl mx-auto">
    ...
    <?php if($user->isProtectedSystemOwner()): ?>
                            ...
                            <div class="space-y-2">
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50">
                                    <input type="radio" name="is_active" value="1" class="border-gray-300" 
                                           <?php echo e(old('is_active', $user->is_active ?? 1) == 1 ? 'checked' : ''); ?>>
                                    <div class="ml-3">
                                ...
                                <label class="flex items-center p-3 border border-gray-200 rounded-lg hover:bg-gray-50 <?php echo e($user->isProtectedSystemOwner() ? 'opacity-50' : ''); ?>">
                                    <input type="radio" name="is_active" value="0" class="border-gray-300"
                                           <?php echo e(old('is_active', $user->is_active ?? 1) == 0 ? 'checked' : ''); ?>

                                           <?php echo e($user->isProtectedSystemOwner() ? 'disabled' : ''); ?>>
                                    <div class="ml-3">
                            ...
                            <select id="clone-user-select" class="flex-1 border border-gray-300 rounded-md px-3 py-2 text-sm">
                                ...
                                <?php
                                    $similarUsers = \App\Models\User::with(['roles', 'functions'])
                                        ...
                                        ->get();
                                ?>
                                <?php $__currentLoopData = $similarUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $similarUser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($similarUser->id); ?>" data-functions="<?php echo e(json_encode($similarUser->getFunctionKeys())); ?>">
                                        <?php echo e($similarUser->name); ?> (<?php echo e($similarUser->roles->first()?->name ?? 'user'); ?>)
                                    </option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
                            ...
                            <?php $__currentLoopData = $allFunctions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category => $functions): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="mb-4">
                                    <div class="sticky top-0 bg-purple-100 px-3 py-2 rounded font-medium text-purple-900 text-sm mb-2">
                                        <?php echo e($category); ?> (<?php echo e(count($functions)); ?> functions)
                                        <button type="button" onclick="toggleCategory('<?php echo e(Str::slug($category)); ?>')" 
                                                class="float-right text-purple-600 hover:text-purple-800">
                                            Toggle All
                                        </button>
                                    </div>
                                    <div class="space-y-1 pl-2" id="category-<?php echo e(Str::slug($category)); ?>">
                                        <?php $__currentLoopData = $functions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <label class="function-item flex items-center p-2 hover:bg-white rounded cursor-pointer text-sm"
                                                   data-search="<?php echo e(strtolower($label)); ?>" data-category="<?php echo e(Str::slug($category)); ?>">
                                                <input type="checkbox" 
                                                       name="function_keys[]" 
                                                       value="<?php echo e($key); ?>"
                                                       class="border-gray-300 rounded mr-2 category-<?php echo e(Str::slug($category)); ?>"
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/users/edit_comprehensive.blade.php ENDPATH**/ ?>