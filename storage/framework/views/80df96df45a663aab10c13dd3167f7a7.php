...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6 max-w-4xl mx-auto space-y-6">
        ...
        <form method="POST" action="<?php echo e(route('admin.slot-templates.store')); ?>"
   ...
   <div class="bg-white shadow rounded p-6">
                    ...
                    <?php $__currentLoopData = $group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="border-t">
                            ...
                            <td class="px-3 py-1 text-sm">
                                <a href="<?php echo e(route('admin.slot-templates.edit', $tpl)); ?>" class="text-blue-600 hover:underline">Edit</a>
                                ...
                                <form action="<?php echo e(route('admin.slot-templates.destroy', $tpl)); ?>" method="POST" class="inline ml-2"
    ...
    <div id="bulkCopyModal" class="fixed inset-0 bg-black bg-opacity-50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-lg p-6 max-w-2xl w-full mx-4">
            ...
            <form id="bulkCopyForm" method="POST" action="<?php echo e(route('admin.slot-templates.bulk-duplicate')); ?>">
                <?php echo csrf_field(); ?>
