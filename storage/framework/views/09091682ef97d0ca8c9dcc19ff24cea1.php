...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div>
                <a href="<?php echo e(route('admin.arrival-time-settings.create')); ?>" 
                        ...
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('admin.arrival-time-settings.show', $setting)); ?>" 
                                    ...
                                    <a href="<?php echo e(route('admin.arrival-time-settings.edit', $setting)); ?>" 
                                    ...
                                    <form method="POST" action="<?php echo e(route('admin.arrival-time-settings.destroy', $setting)); ?>" class="inline" 
