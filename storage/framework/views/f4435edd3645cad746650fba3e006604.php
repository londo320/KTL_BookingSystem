...
<div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white rounded-lg shadow-sm border">
        ...
        <form action="<?php echo e(route('app.trailer-types.update', $trailerType)); ?>" method="POST" class="p-6">
            <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/trailer-types/edit.blade.php ENDPATH**/ ?>