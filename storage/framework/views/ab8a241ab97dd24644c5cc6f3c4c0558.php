            ...
            <tr class="<?php echo e($config['row']); ?>">
              <td class="px-4 py-4 whitespace-nowrap">
                <div class="font-medium">
                  <a href="<?php echo e(route('app.bookings.show', $booking)); ?>" class="text-blue-600 hover:text-blue-800 hover:underline">
              ...
              <td class="px-4 py-4 whitespace-nowrap">
                ...
                <?php if($movement->moved_to_location_at): ?>
                  <div class="text-xs text-yellow-600">In parking: <?php echo e(round($movement->moved_to_location_at->diffInMinutes(now())/60, 1)); ?>h</div>
                <?php endif; ?>
