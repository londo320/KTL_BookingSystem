...
<?php $component->withAttributes([]); ?>
  ...
  <div class="py-6 max-w-7xl mx-auto space-y-8">
    ...
    <form method="GET" action="<?php echo e(route('app.dashboard')); ?>" class="flex items-center gap-4 mb-4">
      <div>
      ...
      <a href="<?php echo e(route('app.dashboard')); ?>" class="text-sm text-gray-600 hover:underline">Reset</a>
    </form>
