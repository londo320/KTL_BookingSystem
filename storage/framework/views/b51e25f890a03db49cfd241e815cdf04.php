...
<div class="py-6 max-w-4xl mx-auto">
  ...
  <div class="mb-4">
    <a href="<?php echo e(route('admin.depots.create')); ?>" class="bg-blue-600 text-white px-4 py-2 rounded">+ New Depot</a>
  </div>
      ...
      <?php $__currentLoopData = $depots; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $depot): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr>
          ...
          <td class="p-2 border space-x-2">
            <a href="<?php echo e(route('admin.depots.edit', $depot)); ?>" class="text-blue-600">Edit</a>
            <form action="<?php echo e(route('admin.depots.destroy', $depot)); ?>" method="POST" class="inline">
              <?php echo csrf_field(); ?>
