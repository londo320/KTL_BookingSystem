...
<?php $component->withAttributes([]); ?>
  ...
  <div class="py-6 max-w-4xl mx-auto space-y-6">
    ...
    <div class="bg-white p-6 shadow rounded">
      <form method="POST" action="<?php echo e(route('admin.booking-types.store')); ?>" class="space-y-4">
        <?php echo csrf_field(); ?>
        <div>
          ...
          <?php $__empty_1 = true; $__currentLoopData = $types; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <tr class="border-t">
              ...
              <td class="px-2 py-1 space-x-2">
                <a href="<?php echo e(route('admin.booking-types.edit', $type)); ?>"
                   class="text-blue-600 hover:underline text-sm">Edit</a>

                <form method="POST"
                      action="<?php echo e(route('admin.booking-types.destroy', $type)); ?>"
