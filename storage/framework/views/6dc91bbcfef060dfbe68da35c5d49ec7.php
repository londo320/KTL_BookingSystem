   ...
   <?php $__env->slot('header', null, []); ?> 
    <div class="flex items-center justify-between">
      ...
      <div class="flex gap-2">
        ...
        <a href="<?php echo e(route('admin.factory-bookings.create')); ?>"
  ...
  <div class="py-6 max-w-7xl mx-auto">
    ...
    <div class="mb-6 bg-white rounded-lg shadow-sm border p-4">
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div>
          <form method="GET" action="<?php echo e(route('admin.factory-bookings.index')); ?>" class="flex gap-2">
      ...
      <?php if(request()->hasAny(['search', 'depot_id', 'status'])): ?>
        <div class="mt-3 pt-3 border-t border-gray-200">
          <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.factory-bookings.index')); ?>" class="text-sm text-blue-600 hover:text-blue-800">
              Clear Filters
            </a>
          </div>
        </div>
              ...
              <td class="px-4 py-3">
                <div class="flex flex-col space-y-1">
                  ...
                  <?php if(in_array($factoryBooking->status, ['arrived', 'processing'])): ?>
                    <a href="<?php echo e(route('admin.factory-bookings.workflow.show', $factoryBooking)); ?>" 
                ...
                <div class="flex flex-col items-center">
                  ...
                  <div class="text-sm text-gray-400 mb-4">
                    <?php if(request()->hasAny(['search', 'depot_id', 'status'])): ?>
                      ...
                      <a href="<?php echo e(route('admin.factory-bookings.index')); ?>" class="text-blue-600 hover:text-blue-800">clear all filters</a>
                    <?php else: ?>
