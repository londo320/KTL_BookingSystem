...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6 max-w-xl mx-auto">
        ...
        <form method="POST" action="<?php echo e(route('admin.slot-templates.update', $slotTemplate)); ?>" class="bg-white p-6 rounded shadow space-y-4">
            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="text-right">
                ...
                <a href="<?php echo e(route('admin.slot-templates.index')); ?>" class="ml-2 text-sm text-gray-600 hover:underline">Cancel</a>
            </div>
        </form>
    </div>
