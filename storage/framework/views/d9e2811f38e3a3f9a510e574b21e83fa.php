    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="<?php echo e(route('app.trailer-types.create')); ?>" 
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50 <?php echo e($trailerType->trashed() ? 'bg-red-50' : ''); ?>">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                            <a href="<?php echo e(route('app.trailer-types.show', $trailerType)); ?>" 
                            ...
                            <div class="flex items-center gap-2">
                                ...
                                <?php else: ?>
                                    ...
                                    <?php if($trailerType->canBeDeleted()): ?>
                                        <form action="<?php echo e(route('app.trailer-types.destroy', $trailerType)); ?>" method="POST" class="inline"
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/trailer-types/index.blade.php ENDPATH**/ ?>