...
<div class="p-6 space-y-4">
  <a href="<?php echo e(route('admin.slot-templates.create')); ?>"
    ...
    <?php $__currentLoopData = $templates; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tpl): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <tr class="border-t">
        ...
        <td class="p-2 space-x-2">
          <a href="<?php echo e(route('admin.slot-templates.edit',$tpl)); ?>"
             class="text-blue-600">Edit</a>
          <form method="POST" action="<?php echo e(route('admin.slot-templates.destroy',$tpl)); ?>"
