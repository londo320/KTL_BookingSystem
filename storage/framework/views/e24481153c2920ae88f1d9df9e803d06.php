    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="flex space-x-3">
          <a href="<?php echo e(route('admin.empty-unit-collection')); ?>"
      ...
      <div class="overflow-x-auto">
        <table class="min-w-full divide-y divide-gray-200">
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <?php $booking = $movement->booking ?>
            <tr class="hover:bg-gray-50">
              <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-blue-600">
                <a href="<?php echo e(route('admin.bookings.show', $booking)); ?>" class="hover:underline">
              ...
              <?php if(!$currentDepotId): ?>
                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                  <?php echo e($booking->slot->depot->name ?? 'Unknown'); ?>

                </td>
              <?php endif; ?>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                <?php echo e($booking->vehicle_registration ?? 'Not specified'); ?>

                <?php if($booking->container_number): ?>
                  <br><span class="text-xs text-gray-500"><?php echo e($booking->container_number); ?></span>
                <?php endif; ?>
              </td>
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm">
                <?php if($movement->tippingBay): ?>
                  ...
                  <form method="POST" action="<?php echo e(route('admin.bookings.clear-bay', $booking)); ?>" class="inline">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/bookings/trailer-location-report.blade.php ENDPATH**/ ?>