     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="<?php echo e(route('admin.bookings.index')); ?>" class="px-3 py-1 bg-gray-300 text-gray-800 rounded hover:bg-gray-400 text-sm">
                    ← Back to Bookings
                </a>
            </div>
        </div>
    ...
    <script>
        ...
        async function updateBayPosition(bayId, x, y, showOnMap) {
            try {
                ...
                const response = await fetch('<?php echo e(route("admin.depot-map.update-position")); ?>', {
                    method: 'POST',
                    headers: {
        ...
        async function updateLocationPosition(locationId, x, y, showOnMap) {
            try {
                ...
                const response = await fetch('<?php echo e(route("admin.depot-map.update-location-position")); ?>', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json',
                        'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/depot-map/manage-positions.blade.php ENDPATH**/ ?>