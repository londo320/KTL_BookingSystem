        ...
        <div class="max-w-7xl mx-auto mb-6 bg-white p-4 rounded-lg shadow">
            <form method="GET" class="flex flex-wrap items-end gap-4">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.dropped-trailers.index')); ?>" class="px-4 py-2 bg-gray-300 text-gray-700 rounded-lg hover:bg-gray-400">
                        Clear
                    </a>
                </div>
            </form>
                                        ...
                                        <div class="flex items-center">
                                            <div>
                                                <div class="text-sm font-medium text-gray-900">
                                                    <a href="<?php echo e(route('admin.bookings.show', $booking)); ?>" class="text-blue-600 hover:text-blue-900">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        ...
                                        <?php if(in_array($booking->tipping_status, ['tipping_completed'])): ?>
                                            ...
                                            <?php if($canTakeAction): ?>
                                                <a href="<?php echo e(route('admin.dropped-trailers.reconnect.form', $booking)); ?>" 
