            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <?php else: ?>
                        ...
                        <!-- Rebook Form -->
                        <form action="<?php echo e(route('admin.bookings.rebook.store', $booking)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="card mt-4">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('admin.bookings.history', $booking)); ?>" class="btn btn-sm btn-outline-primary">
        ...
        <div class="col-md-4">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('admin.customer-behavior.show', $booking->customer)); ?>" class="btn btn-sm btn-outline-info btn-block mt-3">
