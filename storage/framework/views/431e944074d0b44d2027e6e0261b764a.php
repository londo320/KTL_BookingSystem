...
<?php $component->withAttributes([]); ?>
  ...
  <div class="py-6 max-w-2xl mx-auto">
    <div class="bg-white p-6 rounded shadow">
      <form method="POST" action="<?php echo e(route('admin.booking-types.store')); ?>">
        <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH /Users/londo/Herd/test/resources/views/admin/booking_types/create.blade.php ENDPATH**/ ?>