...
<div class="py-6 max-w-4xl mx-auto">
  ...
  <form action="<?php echo e(route('admin.depots.update', $depot)); ?>" method="POST" class="space-y-4 bg-white shadow rounded p-6">
    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/depots/edit.blade.php ENDPATH**/ ?>