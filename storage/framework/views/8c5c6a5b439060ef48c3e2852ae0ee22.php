...
<?php $component->withAttributes([]); ?>
  ...
  <div class="py-6 max-w-2xl mx-auto">
    <div class="bg-white p-6 rounded shadow">
      <form method="POST" action="<?php echo e(route('app.booking-types.store')); ?>">
        <?php echo csrf_field(); ?>
        <div class="mb-4">
          <label class="block text-sm font-medium mb-1">Name</label>
          <input type="text" name="name" class="w-full border rounded p-2" value="<?php echo e(old('name')); ?>">
...
<?php endif; ?>
<?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/booking_types/create.blade.php ENDPATH**/ ?>