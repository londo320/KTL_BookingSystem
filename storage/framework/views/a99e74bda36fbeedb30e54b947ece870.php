            ...
            <div class="space-y-2">
              ...
              <?php if($factoryBooking->status === 'completed'): ?>
                <div class="space-y-3">
                  ...
                  <form method="POST" action="<?php echo e(route('app.factory-booking-workflow.trailer-depart', $factoryBooking)); ?>" class="space-y-3">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/factory-bookings/show.blade.php ENDPATH**/ ?>