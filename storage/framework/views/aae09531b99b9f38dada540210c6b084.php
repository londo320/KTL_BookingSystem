...
<?php $component->withAttributes([]); ?>
  ...
  <div class="py-6 max-w-7xl mx-auto">
    ...
    <?php if($bookingsNeedingFix->count() > 0): ?>
      <div class="bg-white rounded-lg shadow">
        <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
          <div>
            <h3 class="text-lg font-medium text-gray-900">Bookings Needing Fix</h3>
            <p class="text-sm text-gray-600 mt-1"><?php echo e($bookingsNeedingFix->count()); ?> bookings with collected trailers but no departure time</p>
          </div>
          <form method="POST" action="<?php echo e(route($routePrefix . 'bookings.fix-historical-departures.process')); ?>">
            <?php echo csrf_field(); ?>
            <button type="submit" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"
                    onclick="return confirm('Fix <?php echo e($bookingsNeedingFix->count()); ?> booking records?')">
              🔧 Fix All Records
            </button>
          </form>
        </div>
        <div class="overflow-x-auto">
          <table class="min-w-full divide-y divide-gray-200">
            ...
            <tbody class="bg-white divide-y divide-gray-200">
              <?php $__currentLoopData = $bookingsNeedingFix; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                ...
                <tr class="hover:bg-gray-50">
                  <td class="px-6 py-4 whitespace-nowrap">
                    <div class="text-sm font-medium text-blue-600">
                      <a href="<?php echo e(route($routePrefix . 'bookings.show', $booking)); ?>" class="hover:underline">
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                    <?php echo e($booking->arrived_at->format('M j, Y H:i')); ?>

                  </td>
                  <td class="px-6 py-4 whitespace-nowrap">
                    <span class="px-2 py-1 text-xs rounded-full bg-purple-100 text-purple-800">
                      <?php echo e(ucwords(str_replace('_', ' ', $movement?->current_status ?? 'unknown'))); ?>

                    </span>
                  </td>
                  <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                    <?php if($collectionTime): ?>
                      <?php echo e(\Carbon\Carbon::parse($collectionTime)->format('M j, Y H:i')); ?>

                      <div class="text-xs text-gray-400">
                        <?php echo e(\Carbon\Carbon::parse($collectionTime)->diffForHumans($booking->arrived_at, true)); ?> after arrival
                      </div>
                    <?php else: ?>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/bookings/fix-historical-departures.blade.php ENDPATH**/ ?>