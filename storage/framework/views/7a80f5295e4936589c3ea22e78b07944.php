     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                ...
                <a href="<?php echo e(route('admin.tipping-bays.create')); ?>" 
                            ...
                            <?php $__currentLoopData = $bays; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr class="hover:bg-gray-50">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium space-x-2">
                                        <a href="<?php echo e(route('admin.tipping-bays.show', $bay)); ?>" 
                                           class="text-blue-600 hover:text-blue-900">View</a>
                                        <?php if($bay->depot_id === $defaultDepotId): ?>
                                            <a href="<?php echo e(route('admin.tipping-bays.edit', $bay)); ?>" 
                                        ...
                                        <?php if($bay->is_occupied): ?>
                                            <form method="POST" action="<?php echo e(route('admin.tipping-bays.mark-available', $bay)); ?>" 
                                        ...
                                        <?php if(!$bay->is_occupied && $bay->depot_id === $defaultDepotId): ?>
                                            <form method="POST" action="<?php echo e(route('admin.tipping-bays.destroy', $bay)); ?>" 
