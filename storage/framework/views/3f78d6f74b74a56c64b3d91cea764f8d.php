<?php $__env->startSection('title', 'Customer Behavior Analysis'); ?>
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="<?php echo e(route('admin.customer-behavior.flagged')); ?>" 
                   class="inline-flex items-center px-4 py-2 bg-amber-500 hover:bg-amber-600 text-white rounded-lg transition-colors">
                    🚩 Flagged Customers
                </a>
                <a href="<?php echo e(route('admin.customer-behavior.export', ['days' => $days])); ?>" 
                        ...
                        <tr class="hover:bg-gray-50 <?php echo e($customer->risk_level === 'High Risk' ? 'bg-red-50 border-l-4 border-red-500' : ($customer->risk_level === 'Medium Risk' ? 'bg-amber-50 border-l-4 border-amber-500' : '')); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('admin.customer-behavior.show', $customer->id)); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/customer-behavior/index.blade.php ENDPATH**/ ?>