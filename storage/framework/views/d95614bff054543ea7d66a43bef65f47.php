<?php $__env->startSection('title', 'Edit Import Template - ' . $template->name); ?>
    ...
    <div class="max-w-7xl mx-auto">
                ...
                <nav class="flex mb-4" aria-label="Breadcrumb">
                    <ol class="inline-flex items-center space-x-1 md:space-x-3">
                        <li class="inline-flex items-center">
                            <a href="<?php echo e(route('outbound.dashboard')); ?>" class="text-gray-500 hover:text-gray-700">
                        ...
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="<?php echo e(route('outbound.imports.dashboard')); ?>" class="ml-1 text-gray-500 hover:text-gray-700 md:ml-2">Imports</a>
                            </div>
                        </li>
                        <li>
                            <div class="flex items-center">
                                ...
                                <a href="<?php echo e(route('outbound.imports.templates')); ?>" class="ml-1 text-gray-500 hover:text-gray-700 md:ml-2">Templates</a>
                            </div>
                        </li>
                        <li aria-current="page">
                            <div class="flex items-center">
                                ...
                                <span class="ml-1 text-gray-800 font-medium md:ml-2"><?php echo e($template->name); ?></span>
                            </div>
                        </li>
                    </ol>
                </nav>
                    ...
                    <div class="flex items-center space-x-4">
                        ...
                        <div>
                            ...
                            <div class="flex items-center space-x-3 mt-1">
                                <span class="text-sm text-gray-600"><?php echo e($template->source_system); ?></span>
        ...
        <div class="bg-white border-b border-gray-200 sticky top-0 z-40">
            <div class="px-4 sm:px-6 lg:px-8">
                <nav class="flex space-x-8 py-4" aria-label="Tabs">
                    ...
                    <?php if($availableHeaders->isNotEmpty() || $previewData): ?>
        ...
        <div class="px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-2xl font-bold text-gray-900"><?php echo e($template->files_processed ?? 0); ?></div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-2xl font-bold text-gray-900"><?php echo e(count($template->column_mapping ?? [])); ?></div>
                        ...
                        <div class="flex items-center">
                            ...
                            <div class="ml-4">
                                <div class="text-lg font-bold text-gray-900">
                                    <?php echo e($template->last_used_at ? $template->last_used_at->diffForHumans() : 'Never'); ?>
                    ...
                    <div class="p-6">
                        <dl class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900 font-medium"><?php echo e($template->name); ?></dd>
                            </div>
                            <div>
                                <dt class="text-sm font-medium text-gray-500">Source System</dt>
                                <dd class="mt-1 text-sm text-gray-900"><?php echo e($template->source_system); ?></dd>
                            </div>
                            <div>
                            ...
                            <div>
                                ...
                                <dd class="mt-1 text-sm text-gray-900 capitalize"><?php echo e(str_replace('_', ' ', $template->duplicate_handling)); ?></dd>
                            </div>
                            <div>
                        ...
                        <?php if($template->description): ?>
                            <div class="mt-6 pt-6 border-t border-gray-200">
                                ...
                                <dd class="text-sm text-gray-900"><?php echo e($template->description); ?></dd>
                            </div>
                        <?php endif; ?>
                    </div>
                </div>
            ...
            <div id="preview" class="tab-content hidden">
                <!-- Available Headers -->
                <?php if($availableHeaders->isNotEmpty()): ?>
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="px-6 py-4 border-b border-gray-200">
                        ...
                        <?php if($recentUploads->count() > 1): ?>
                            <p class="text-xs text-gray-500 mt-1">Based on <?php echo e($recentUploads->count()); ?> recent files</p>
                        <?php endif; ?>
                    </div>
                    <div class="p-6">
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-2">
                            <?php $__currentLoopData = $availableHeaders; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center p-3 bg-gray-50 rounded-lg cursor-pointer hover:bg-blue-50 transition-colors border border-transparent hover:border-blue-200" 
                                     onclick="copyToClipboard('<?php echo e(addslashes($header)); ?>')">
                                    <span class="text-sm font-mono text-gray-800 flex-1"><?php echo e($header); ?></span>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            $currentMapping = old('column_mapping', $template->column_mapping ?? []);
                            ?>
                            <?php $__currentLoopData = $requiredFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-4 <?php echo e(!empty($currentMapping[$key]) ? 'bg-green-50 border-green-200' : 'bg-red-50 border-red-200'); ?> border rounded-lg">
                                    <div class="flex items-center">
                                        <?php if(!empty($currentMapping[$key])): ?>
                                        ...
                                        <?php endif; ?>
                                        <div>
                                            <h4 class="font-medium <?php echo e(!empty($currentMapping[$key]) ? 'text-green-900' : 'text-red-900'); ?>"><?php echo e($label); ?></h4>
                                            <p class="text-sm <?php echo e(!empty($currentMapping[$key]) ? 'text-green-700' : 'text-red-700'); ?>">
                                                <?php if(!empty($currentMapping[$key])): ?>
                                                    Mapped to: <span class="font-mono bg-white px-2 py-1 rounded border"><?php echo e($currentMapping[$key]); ?></span>
                                                <?php else: ?>
                ...
                <!-- File Preview -->
                <?php if($previewData && $selectedUpload): ?>
                <div class="bg-white rounded-xl shadow-sm border border-gray-200">
                    <div class="px-6 py-4 border-b border-gray-200">
                        <div class="flex items-center justify-between">
                            <div>
                                ...
                                <p class="text-sm text-gray-600">
                                    Sample from: <strong><?php echo e($selectedUpload->original_filename); ?></strong> 
                                    (uploaded <?php echo e($selectedUpload->uploaded_at->diffForHumans()); ?>)
                                </p>
                            </div>
                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                <?php echo e(min(count($previewData), 100)); ?> records
                            </span>
                        </div>
                    </div>
                    <div class="p-6">
                        <div class="overflow-x-auto">
                            <table class="min-w-full divide-y divide-gray-200 text-sm">
                                <thead class="bg-gray-50">
                                    <tr>
                                        <?php $headers = array_keys($previewData[0] ?? []); ?>
                                        <?php $__currentLoopData = $headers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <th class="px-4 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider border-r border-gray-200 last:border-r-0">
                                                <div class="flex items-center space-x-1">
                                                    <span><?php echo e($header); ?></span>
                                                    <button onclick="copyToClipboard('<?php echo e(addslashes($header)); ?>')" 
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <?php $__currentLoopData = array_slice($previewData, 0, 10); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $row): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr class="<?php echo e($index % 2 == 0 ? 'bg-white' : 'bg-gray-50'); ?> hover:bg-blue-50 group">
                                            <?php $__currentLoopData = $headers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                <td class="px-4 py-3 whitespace-nowrap text-gray-900 border-r border-gray-200 last:border-r-0 max-w-xs truncate">
                                                    <span title="<?php echo e($row[$header] ?? ''); ?>"><?php echo e($row[$header] ?? ''); ?></span>
                                                </td>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <?php if(count($previewData) > 10): ?>
                                <div class="mt-4 text-center p-4 bg-gradient-to-r from-gray-50 to-blue-50 border-t border-gray-200">
                                    <p class="text-sm text-gray-600">
                                        📊 Showing first 10 rows of <?php echo e(count($previewData)); ?> total preview records
            ...
            <div id="mapping" class="tab-content hidden">
                <form method="POST" action="<?php echo e(route('outbound.imports.templates.update', $template)); ?>" class="space-y-8">
                    <?php echo csrf_field(); ?>
                        ...
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    <?php $__currentLoopData = $availableHeaders->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $header): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <button type="button" 
                                                onclick="copyToClipboard('<?php echo e(addslashes($header)); ?>')"
                                            ...
                                            <span class="font-mono"><?php echo e($header); ?></span>
                                            <svg class="w-3 h-3 ml-1.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 16H6a2 2 0 01-2-2V6a2 2 0 012-2h8a2 2 0 012 2v2m-6 12h8a2 2 0 002-2v-8a2 2 0 00-2-2h-8a2 2 0 00-2 2v8a2 2 0 002 2z"/>
                                            </svg>
                                        </button>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($availableHeaders->count() > 8): ?>
                                        <span class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-medium bg-white text-gray-600 border border-gray-200">
                                            +<?php echo e($availableHeaders->count() - 8); ?> more in Data Preview tab
                                        </span>
                                    <?php endif; ?>
                                </div>
                            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="source_system" 
                               name="source_system" 
                               value="<?php echo e($template->source_system); ?>"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               value="<?php echo e(strtoupper($template->file_type)); ?>"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md bg-gray-50 text-gray-500" 
                               readonly>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <textarea id="description" 
                                  name="description" 
                                  rows="3"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500"><?php echo e(old('description', $template->description)); ?></textarea>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white rounded-lg shadow">
                ...
                <div class="p-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                        <?php if(in_array($template->file_type, ['csv', 'txt'])): ?>
                            <div>
                                <label for="delimiter" class="block text-sm font-medium text-gray-700 mb-2">Column Delimiter</label>
                                <select id="delimiter" 
                                        name="delimiter" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                    <option value="," <?php echo e(old('delimiter', $template->delimiter) === ',' ? 'selected' : ''); ?>>Comma (,)</option>
                                    <option value=";" <?php echo e(old('delimiter', $template->delimiter) === ';' ? 'selected' : ''); ?>>Semicolon (;)</option>
                                    <option value="|" <?php echo e(old('delimiter', $template->delimiter) === '|' ? 'selected' : ''); ?>>Pipe (|)</option>
                                    <option value="\t" <?php echo e(old('delimiter', $template->delimiter) === "\t" ? 'selected' : ''); ?>>Tab</option>
                                </select>
                            </div>
                            ...
                            <div>
                                ...
                                <select id="text_qualifier" 
                                        name="text_qualifier" 
                                        class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                    <option value="\"" <?php echo e(old('text_qualifier', $template->text_qualifier) === '"' ? 'selected' : ''); ?>>Double Quote (")</option>
                                    <option value="'" <?php echo e(old('text_qualifier', $template->text_qualifier) === "'" ? 'selected' : ''); ?>>Single Quote (')</option>
                                    <option value="" <?php echo e(old('text_qualifier', $template->text_qualifier) === '' ? 'selected' : ''); ?>>None</option>
                                </select>
                            </div>
                        <?php endif; ?>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="header_row" 
                                   name="header_row" 
                                   value="<?php echo e(old('header_row', $template->header_row)); ?>"
                                   min="0"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" 
                                   required>
                        ...
                        <div>
                            ...
                            <input type="number" 
                                   id="data_start_row" 
                                   name="data_start_row" 
                                   value="<?php echo e(old('data_start_row', $template->data_start_row)); ?>"
                                   min="1"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500" 
                                   required>
                        ...
                        <div class="md:col-span-2">
                            ...
                            <select id="encoding" 
                                    name="encoding" 
                                    class="w-full px-3 py-2 border border-gray-300 rounded-md focus:ring-blue-500 focus:border-blue-500">
                                <option value="UTF-8" <?php echo e(old('encoding', $template->encoding) === 'UTF-8' ? 'selected' : ''); ?>>UTF-8</option>
                                <option value="ISO-8859-1" <?php echo e(old('encoding', $template->encoding) === 'ISO-8859-1' ? 'selected' : ''); ?>>ISO-8859-1 (Latin-1)</option>
                                <option value="Windows-1252" <?php echo e(old('encoding', $template->encoding) === 'Windows-1252' ? 'selected' : ''); ?>>Windows-1252</option>
                            </select>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="space-y-3">
                            ...
                            <?php $__currentLoopData = $requiredFields; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $label): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-3 bg-red-50 border border-red-200 rounded-lg">
                                    <div>
                                        <h4 class="font-medium text-red-900"><?php echo e($label); ?></h4>
                                        <p class="text-sm text-red-700">Currently mapped to: 
                                            <?php if(!empty($currentMapping[$key])): ?>
                                                <span class="font-mono bg-red-100 px-2 py-1 rounded"><?php echo e($currentMapping[$key]); ?></span>
                                            <?php else: ?>
            ...
            <div class="bg-white rounded-lg shadow">
                <div class="px-6 py-4 border-b border-gray-200">
                    ...
                    <p class="text-xs text-gray-500 mt-1">Showing first <?php echo e(min(count($previewData), 100)); ?> records</p>
                </div>
                <div class="p-6">
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            ...
                            <div class="flex items-center space-x-4 p-3 bg-gray-50 rounded-lg">
                                ...
                                <div class="flex-1">
                                    <input type="text" 
                                           ...
                                           value="<?php echo e($currentMapping[$key] ?? ''); ?>"
                ...
                <div class="p-6 space-y-6">
                    <div class="flex items-center space-x-3">
                        <input type="checkbox" 
                               ...
                               name="auto_process" 
                               value="1"
                               <?php echo e(old('auto_process', $template->auto_process) ? 'checked' : ''); ?>
                    ...
                    <div>
                        ...
                        <select id="duplicate_handling" 
                                ...
                                required>
                            <option value="skip" <?php echo e(old('duplicate_handling', $template->duplicate_handling) === 'skip' ? 'selected' : ''); ?>>Skip duplicates</option>
                            <option value="overwrite" <?php echo e(old('duplicate_handling', $template->duplicate_handling) === 'overwrite' ? 'selected' : ''); ?>>Overwrite existing</option>
                            <option value="create_new" <?php echo e(old('duplicate_handling', $template->duplicate_handling) === 'create_new' ? 'selected' : ''); ?>>Create new record</option>
                        </select>
            ...
            <div class="flex justify-between">
                <div>
                    <?php if($template->files_processed > 0): ?>
                        <p class="text-sm text-gray-600">
                            ⚠️ This template has processed <?php echo e($template->files_processed); ?> files. 
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div>
                                ...
                                <textarea id="description" 
                                          ...
                                          class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"><?php echo e(old('description', $template->description)); ?></textarea>
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <div class="relative">
                                        <input type="radio" 
                                               ...
                                               name="duplicate_handling" 
                                               value="skip" 
                                               <?php echo e(old('duplicate_handling', $template->duplicate_handling) === 'skip' ? 'checked' : ''); ?>
                                    ...
                                    <div class="relative">
                                        <input type="radio" 
                                               ...
                                               name="duplicate_handling" 
                                               value="overwrite" 
                                               <?php echo e(old('duplicate_handling', $template->duplicate_handling) === 'overwrite' ? 'checked' : ''); ?>
                                    ...
                                    <div class="relative">
                                        <input type="radio" 
                                               ...
                                               name="duplicate_handling" 
                                               value="create_new" 
                                               <?php echo e(old('duplicate_handling', $template->duplicate_handling) === 'create_new' ? 'checked' : ''); ?>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <select id="encoding" 
                                            name="encoding" 
                                            class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors">
                                        <option value="UTF-8" <?php echo e(old('encoding', $template->encoding) === 'UTF-8' ? 'selected' : ''); ?>>UTF-8 (Recommended)</option>
                                        <option value="ISO-8859-1" <?php echo e(old('encoding', $template->encoding) === 'ISO-8859-1' ? 'selected' : ''); ?>>ISO-8859-1 (Latin-1)</option>
                                        <option value="Windows-1252" <?php echo e(old('encoding', $template->encoding) === 'Windows-1252' ? 'selected' : ''); ?>>Windows-1252</option>
                                    </select>
                                </div>
                            ...
                            <div>
                                <?php if($template->files_processed > 0): ?>
                                    <div class="flex items-center text-sm text-amber-700 bg-amber-50 px-3 py-2 rounded-lg border border-amber-200">
                                        ...
                                        This template has processed <?php echo e($template->files_processed); ?> files. Changes will only affect future imports.
                                    </div>
                                <?php endif; ?>
                            </div>
                            <div class="flex space-x-3">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/outbound/admin/imports/templates/edit.blade.php ENDPATH**/ ?>