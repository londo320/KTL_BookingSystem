              ...
              <td class="px-6 py-4 whitespace-nowrap">
                <?php
                  ...
                  $statusDisplay = match($movement->current_status) {
                    ...
                    'back_to_parking' => $hasCompletedTipping ? '✅ Empty - Ready for Collection' : '⏳ In Parking Area',
                    'awaiting_collection' => '✅ Empty - Ready for Collection',
                  ...
                  $statusClass = match($movement->current_status) {
                    ...
                    'back_to_parking' => $hasCompletedTipping ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800',
