...
<body>
    <div class="container">
        <div class="header">
            ...
            <p><?php echo e($booking->customer->name ?? 'Not assigned'); ?> | Generated: <?php echo e(now()->format('d M Y, H:i')); ?></p>
        </div>
            ...
            <div class="column">
                ...
                <div class="section">
                    ...
                    <?php if($booking->expected_cases || $booking->actual_cases): ?>
                        <div class="load-row">
                            <div class="load-expected">
                                <strong>Cases:</strong> <?php echo e(number_format($booking->expected_cases ?? 0)); ?>

                            </div>
                            <?php if($booking->actual_cases): ?>
                                <div class="load-arrow">→</div>
                                <div class="load-actual">
                                    <strong><?php echo e(number_format($booking->actual_cases)); ?></strong>
                    ...
                    <?php if($booking->expected_pallets || $booking->actual_pallets): ?>
                        <div class="load-row">
                            <div class="load-expected">
                                <strong>Pallets:</strong> <?php echo e(number_format($booking->expected_pallets ?? 0)); ?>

                            </div>
                            <?php if($booking->actual_pallets): ?>
                                <div class="load-arrow">→</div>
                                <div class="load-actual">
                                    <strong><?php echo e(number_format($booking->actual_pallets)); ?></strong>
...
</html><?php /**PATH /Users/londo/Herd/test/resources/views/customer/bookings/pdf-compact.blade.php ENDPATH**/ ?>