...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                <a href="<?php echo e(route('admin.tipping-bays.show', $tippingBay)); ?>" 
    ...
    <div class="py-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <form method="POST" action="<?php echo e(route('admin.tipping-bays.update', $tippingBay)); ?>" class="p-6">
                <?php echo csrf_field(); ?>
                            ...
                            <div class="flex items-start">
                                ...
                                <div class="ml-3">
                                    ...
                                    <ul class="mt-2 text-sm text-blue-700 space-y-1">
                                        ...
                                        <li>• Use the <a href="<?php echo e(route('admin.depot-map.manage-positions')); ?>" class="underline hover:no-underline">Map Position Manager</a> for drag-and-drop positioning</li>
