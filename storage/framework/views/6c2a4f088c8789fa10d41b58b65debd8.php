...
<div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="<?php echo e(route('app.arrival-time-settings.show', $arrivalTimeSetting)); ?>" 
                   class="inline-flex items-center px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg transition-colors">
                    👁️ View Details
                </a>
                <a href="<?php echo e(route('app.arrival-time-settings.index')); ?>" 
    ...
    <div class="bg-white rounded-lg shadow-sm border">
        ...
        <form method="POST" action="<?php echo e(route('app.arrival-time-settings.update', $arrivalTimeSetting)); ?>" class="p-6">
            <?php echo csrf_field(); ?>
