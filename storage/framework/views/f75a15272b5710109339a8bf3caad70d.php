      ...
      <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <tr class="border-t hover:bg-gray-50">
          ...
          <td class="px-4 py-2 space-x-2">
            ...
            <a href="<?php echo e(route('app.customers.booking-config.edit', $customer)); ?>"
               class="px-2 py-1 bg-green-500 text-white rounded hover:bg-green-600 text-xs">
               📦 Booking Config
            </a>
            <a href="<?php echo e(route('app.customers.time-windows.edit', $customer)); ?>"
               class="px-2 py-1 bg-blue-500 text-white rounded hover:bg-blue-600 text-xs">
               🕐 Time Windows
            </a>
            <a href="<?php echo e(route('app.customers.bay-assignments.edit', $customer)); ?>"
