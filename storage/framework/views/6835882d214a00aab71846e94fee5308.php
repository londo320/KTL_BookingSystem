...
<div x-data="poNumbersManager(<?php echo e($customer_id ?? 'null'); ?>)" x-init="init(<?php echo e($existingData->toJson()); ?>); window.poNumbersManagerInstance = this;" <?php if($readonly): ?> data-readonly="true" <?php endif; ?>>
