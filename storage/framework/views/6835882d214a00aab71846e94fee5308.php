...
<div x-data="poNumbersManager(<?php echo e($customer_id ?? 'null'); ?>)"
     x-init="init(<?php echo e($existingData->toJson()); ?>); window.poNumbersManagerInstance = this; watchCustomerField();"
     <?php if($readonly): ?> data-readonly="true" <?php endif; ?>>
                ...
                <div class="border border-gray-200 rounded-lg p-4 bg-gray-50">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" x-model="po.po_number" 
                               ...
                               class="mt-1 block w-full border-gray-300 rounded <?php echo e($readonly ? 'bg-gray-100' : ''); ?>"
                                        ...
                                        <div class="flex gap-1.5 items-end">
                                            ...
                                            <div class="flex-1 min-w-[200px]" data-sku-field-container>
                                                ...
                                                <input type="text" x-model="line.description"
                                                       ...
                                                       :class="line.product_id ? 'h-7 w-full border-gray-300 rounded text-xs px-2 bg-gray-100' : 'h-7 w-full border-gray-300 rounded text-xs px-2 <?php echo e($readonly ? 'bg-gray-100' : ''); ?>'"
                                                       <?php echo e($readonly ? 'readonly' : ''); ?>>
                                            </div>
                                        ...
                                        <div class="mb-3 flex gap-2 items-start" data-sku-field-container>
                                            ...
                                            <div class="flex-1 min-w-0">
                                                ...
                                                <input type="text" x-model="line.description"
                                                       ...
                                                       placeholder="Product description"
                                                       :readonly="line.product_id ? true : false"
                                                       :class="line.product_id ? 'block w-full border-gray-300 rounded text-xs bg-gray-100' : 'block w-full border-gray-300 rounded text-xs <?php echo e($readonly ? 'bg-gray-100' : ''); ?>'"
                                                       <?php echo e($readonly ? 'readonly' : ''); ?>>
                                            </div>
                                        </div>
...
</script><?php /**PATH /Users/londo/Herd/test/resources/views/components/booking-po-numbers.blade.php ENDPATH**/ ?>