<?php $__env->startSection('title', 'Merge Carriers'); ?>
...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <!-- Suggested Merges -->
    <?php if($suggestedMerges->count() > 0): ?>
        <div class="mb-8 p-6 bg-yellow-50 border border-yellow-200 rounded-lg">
            ...
            <?php $__currentLoopData = $suggestedMerges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $normalizedName => $group): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="mb-6 p-4 bg-white rounded-lg border">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3 mb-4">
                        <?php $__currentLoopData = $group; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="p-3 border rounded <?php echo e($carrier->is_active ? 'bg-green-50 border-green-200' : 'bg-gray-50 border-gray-200'); ?>">
                                <div class="font-medium text-sm"><?php echo e($carrier->name); ?></div>
                                <div class="text-xs text-gray-600 mt-1">
                                    📦 <?php echo e($carrier->bookings_count); ?> bookings
                                    <?php if($carrier->last_used_at): ?>
                                        • Last used: <?php echo e($carrier->last_used_at->diffForHumans()); ?>
                    ...
                    <button onclick="setupQuickMerge(<?php echo e($group->pluck('id')->toJson()); ?>, <?php echo e($group->toJson()); ?>)" 
    ...
    <div class="bg-white rounded-lg shadow-sm border">
        ...
        <div class="p-6">
            <form id="merge-form" action="<?php echo e(route('admin.carriers.merge.execute')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                        ...
                        <select name="source_carrier_id" id="source-carrier" required 
                            ...
                            <?php $__currentLoopData = $carriers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($carrier->id); ?>" 
                                        data-bookings="<?php echo e($carrier->bookings_count); ?>"
                                        data-active="<?php echo e($carrier->is_active ? 'true' : 'false'); ?>"
                                        data-deleted="<?php echo e($carrier->trashed() ? 'true' : 'false'); ?>">
                                    <?php echo e($carrier->name); ?> 
                                    (<?php echo e($carrier->bookings_count); ?> bookings)
                                    <?php echo e($carrier->is_active ? '' : ' - INACTIVE'); ?>

                                    <?php echo e($carrier->trashed() ? ' - DELETED' : ''); ?>
                    ...
                    <div class="bg-green-50 border border-green-200 rounded-lg p-6">
                        ...
                        <select name="target_carrier_id" id="target-carrier" required 
                            ...
                            <?php $__currentLoopData = $carriers->where('is_active', true)->where('deleted_at', null); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $carrier): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($carrier->id); ?>" 
                                        data-bookings="<?php echo e($carrier->bookings_count); ?>">
                                    <?php echo e($carrier->name); ?> (<?php echo e($carrier->bookings_count); ?> bookings)
                                </option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </select>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="divide-y divide-gray-200">
                        <?php $__currentLoopData = $recentMerges; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $merge): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="hover:bg-gray-50">
                            <td class="px-6 py-4 text-sm text-gray-900">
                                <?php echo e($merge->created_at->format('M j, Y H:i')); ?>

                            </td>
                            <td class="px-6 py-4 text-sm">
                                <div class="font-medium text-red-600"><?php echo e($merge->source_carrier_name); ?></div>
                                <div class="text-gray-500">→ <?php echo e($merge->target_carrier_name); ?></div>
                            </td>
                            <td class="px-6 py-4 text-center text-sm text-gray-900">
                                <?php echo e($merge->bookings_moved); ?>

                            </td>
                            <td class="px-6 py-4 text-sm text-gray-900">
                                <?php echo e($merge->mergedBy->name ?? 'Unknown'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.previewMerge = function() {
        ...
        fetch(`<?php echo e(route('admin.carriers.merge.preview')); ?>?source_carrier_id=${sourceId}&target_carrier_id=${targetId}`)
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/carriers/merge/index.blade.php ENDPATH**/ ?>