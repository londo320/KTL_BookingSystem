...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex items-center justify-between">
            ...
            <div class="flex gap-3">
                <a href="<?php echo e(route('app.carriers.merge.history')); ?>" 
    ...
    <div class="bg-white rounded-lg shadow-sm border">
        ...
        <div class="p-6">
            <form id="merge-form" action="<?php echo e(route('app.carriers.merge.execute')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    window.previewMerge = function() {
        ...
        fetch(`<?php echo e(route('app.carriers.merge.preview')); ?>?source_carrier_id=${sourceId}&target_carrier_id=${targetId}`)
