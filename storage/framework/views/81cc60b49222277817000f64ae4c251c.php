     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            <div class="flex items-center space-x-4">
                ...
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">
                        <?php echo e($booking->slot->depot->name); ?> • <?php echo e($booking->slot->start_at->format('d M Y, H:i')); ?>
            ...
            <div class="flex items-center space-x-2">
                ...
                <?php if($booking->bookingType): ?>
                    <span class="px-3 py-1 bg-gray-100 text-gray-800 rounded-full text-sm">
                        <?php echo e($booking->bookingType->name); ?>
            ...
            <div class="bg-white shadow rounded-lg">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
                    ...
                    <div class="lg:col-span-2">
                        <form method="POST" action="<?php echo e(route('app.bookings.arrival', $booking)); ?>">
                            <?php echo csrf_field(); ?>
                            <?php if($errors->any()): ?>
                            ...
                            <?php if($booking->poNumbers && $booking->poNumbers->count() > 0): ?>
                                ...
                                <div class="space-y-3 mb-4">
                                    <div class="text-sm font-medium text-blue-700 mb-2">
                                        <?php echo e($booking->poNumbers->count()); ?> PO Number<?php echo e($booking->poNumbers->count() > 1 ? 's' : ''); ?>:
                                    </div>
                                    <?php $__currentLoopData = $booking->poNumbers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $po): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="bg-white rounded-lg p-3 border border-blue-200">
                                            ...
                                            <?php if($po->total_expected_cases > 0 || $po->total_expected_pallets > 0): ?>
                                                <!-- Expected Quantities -->
                                                <div class="grid grid-cols-2 gap-2 text-xs">
                                                    <div class="bg-gray-50 p-2 rounded">
                                                        <div class="text-gray-600">Expected Cases</div>
                                                        <div class="font-semibold text-lg"><?php echo e(number_format($po->total_expected_cases)); ?></div>
                                                    </div>
                                                    <div class="bg-gray-50 p-2 rounded">
                                                        <div class="text-gray-600">Expected Pallets</div>
                                                        <div class="font-semibold text-lg"><?php echo e(number_format($po->total_expected_pallets)); ?></div>
                                                    </div>
                                                </div>
                                                <?php if($po->lines->count() > 0): ?>
                                                    <div class="mt-2 text-xs text-gray-500">
                                                        <?php echo e($po->lines->count()); ?> line<?php echo e($po->lines->count() > 1 ? 's' : ''); ?>
                                            ...
                                            <?php else: ?>
                                                ...
                                                <div class="bg-yellow-50 border border-yellow-200 rounded p-2">
                                                    ...
                                                    <?php else: ?>
                                                        <div class="text-xs text-gray-500 mt-1">
                                                            <?php echo e($po->lines->count()); ?> line<?php echo e($po->lines->count() > 1 ? 's' : ''); ?> with no quantities
                                                        </div>
                                                    <?php endif; ?>
                                                </div>
                                            <?php endif; ?>
                                ...
                                <div class="border-t border-blue-300 pt-3">
                                    ...
                                    <div class="bg-blue-100 rounded-lg p-3 space-y-2">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="font-bold text-lg text-blue-700"><?php echo e(number_format($booking->total_expected_cases)); ?></span>
                                        </div>
                                        <div class="flex justify-between items-center">
                                            <span class="text-sm">🎯 Pallets:</span>
                                            <span class="font-bold text-lg text-blue-700"><?php echo e(number_format($booking->total_expected_pallets)); ?></span>
                                        </div>
                                    </div>
                                </div>
                            <?php else: ?>
                                ...
                                <div class="text-center py-6 text-gray-500">
                                    ...
                                    <div class="text-xs mt-1">Expected: <?php echo e(number_format($booking->total_expected_cases)); ?> cases, <?php echo e(number_format($booking->total_expected_pallets)); ?> pallets</div>
                                </div>
                            <?php endif; ?>
                            <!-- Info Note -->
                ...
                <div class="border-t border-gray-200 bg-gray-50 px-6 py-4">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-xs text-gray-500">
                            <?php echo e(now()->format('Y')); ?> © Knowles Logistics - All rights reserved
                        </div>
                    </div>
                </div>
            </div>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/bookings/arrival-form.blade.php ENDPATH**/ ?>