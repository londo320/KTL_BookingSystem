...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <form method="POST" action="<?php echo e(route('admin.bookings.transfer-bay', $booking)); ?>" class="p-6">
                <?php echo csrf_field(); ?>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/bookings/transfer-bay.blade.php ENDPATH**/ ?>