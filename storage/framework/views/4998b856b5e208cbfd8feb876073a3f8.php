                ...
                <select name="collected_from_booking_id" required
                  ...
                  <?php $__currentLoopData = $availableTrailers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $booking): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($booking->id); ?>" <?php echo e(old('collected_from_booking_id') == $booking->id ? 'selected' : ''); ?>>
                      <?php echo e($booking->trailer_display_number); ?>

                      - <?php echo e($booking->location_display); ?>

                      - <?php if($booking->movement_status === 'empty'): ?> Empty <?php elseif($booking->movement_status === 'trailer_dropped'): ?> Full <?php else: ?> <?php echo e(ucwords(str_replace('_', ' ', $booking->movement_status))); ?> <?php endif; ?>
                    </option>
          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                <?php echo e($booking->location_display ?? 'Unknown'); ?>
              ...
              <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-600">
                <?php echo e($booking->customer_name ?? 'Unknown'); ?>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        const bookingData = {
            ...
            <?php echo e($booking->id); ?>: {
                booking_reference: '<?php echo e($booking->booking_reference); ?>',
                trailer_number: '<?php echo e($booking->trailer_display_number); ?>',
                carrier_name: '<?php echo e(addslashes($booking->carrier_company ?? '')); ?>',
                current_location: '<?php echo e(addslashes($booking->location_display ?? '')); ?>',
                customer_name: '<?php echo e(addslashes($booking->customer_name ?? '')); ?>',
                status: '<?php if($booking->movement_status === "empty"): ?> Empty - Ready <?php elseif($booking->movement_status === "trailer_dropped"): ?> Full - Dropped <?php else: ?> <?php echo e(ucwords(str_replace("_", " ", $booking->movement_status))); ?> <?php endif; ?>',
                depot_name: '<?php echo e(addslashes($booking->depot_name ?? '')); ?>'
            },
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        };
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/bookings/empty-unit-collection.blade.php ENDPATH**/ ?>