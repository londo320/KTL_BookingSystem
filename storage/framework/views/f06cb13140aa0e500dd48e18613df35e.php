    ...
    <div class="mb-4 flex items-center justify-between">
        ...
        <div class="flex gap-2">
            <a href="<?php echo e(route('app.users.index')); ?>"
               class="px-3 py-2 <?php echo e(!$showDeleted ? 'bg-gray-800 text-white' : 'bg-gray-200 text-gray-700'); ?> rounded hover:bg-gray-700 hover:text-white">
                Active Users
            </a>
            <a href="<?php echo e(route('app.users.index', ['show_deleted' => 1])); ?>"
               class="px-3 py-2 <?php echo e($showDeleted ? 'bg-red-600 text-white' : 'bg-gray-200 text-gray-700'); ?> rounded hover:bg-red-700 hover:text-white">
                🗑️ Deleted Users
            </a>
        </div>
    </div>
    ...
    <div class="mb-4 bg-white p-4 rounded-lg border">
        <form method="GET" class="flex flex-wrap gap-4 items-end">
            ...
            <div class="min-w-48">
                ...
                <select name="customer_id" class="w-full px-3 py-2 border border-gray-300 rounded focus:outline-none focus:ring-2 focus:ring-blue-500">
                    ...
                    <?php $__currentLoopData = $customers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $customer): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option value="<?php echo e($customer->id); ?>" <?php echo e($customerFilter == $customer->id ? 'selected' : ''); ?>>
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('app.users.index', ['show_deleted' => $showDeleted ? '1' : ''])); ?>" 
                ...
                <div class="flex flex-col space-y-1">
                  <?php if($showDeleted): ?>
                    ...
                    <?php if($user->canBeEditedBy(auth()->user())): ?>
                      ...
                      <form action="<?php echo e(route('app.users.restore', $user)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit"
