<?php $__env->startSection('title', 'Trailer Type Details'); ?>
        ...
        <div class="lg:col-span-1">
            ...
            <div class="mt-6 bg-white rounded-lg shadow-sm border">
                ...
                <div class="p-6 space-y-3">
                    <form action="<?php echo e(route('admin.trailer-types.toggle', $trailerType->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <button type="submit" 
                    ...
                    <?php if($trailerType->canBeDeleted()): ?>
                        <form action="<?php echo e(route('admin.trailer-types.destroy', $trailerType)); ?>" method="POST"
        ...
        <div class="lg:col-span-2">
            <div class="bg-white rounded-lg shadow-sm border">
                ...
                <div class="p-4 border-t bg-gray-50 text-center">
                    <a href="<?php echo e(route('admin.bookings.index', ['trailer_type_id' => $trailerType->id])); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/trailer-types/show.blade.php ENDPATH**/ ?>