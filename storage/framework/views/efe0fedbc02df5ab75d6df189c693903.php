...
<body>
    <div class="header">
        ...
        <p>Customer: <?php echo e($booking->customer->name ?? 'Not assigned'); ?></p>
    ...
    <?php elseif($isLocked): ?>
        <div class="status-banner locked">
            ...
            Cut-off time passed: <?php echo e($booking->slot->locked_at->format('d M Y, H:i')); ?>

        </div>
    <?php else: ?>
        <div class="status-banner">
            <strong><span class="emoji">📅</span>Booking Confirmed</strong><br>
...
</html><?php /**PATH /Users/londo/Herd/test/resources/views/customer/bookings/pdf.blade.php ENDPATH**/ ?>