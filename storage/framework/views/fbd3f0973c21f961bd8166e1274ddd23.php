...
<body class="min-h-screen bg-cover bg-center" style="background-image: url('/images/warehouse-hero.jpg')">
  ...
  <footer class="absolute bottom-0 w-full text-center text-sm text-white opacity-75 p-4">
    © <?php echo e(date('Y')); ?> Knowles Logistics · <a href="/privacy" class="underline">Privacy</a> · <a href="/contact" class="underline">Contact</a>
  </footer>
</body>
</html>
<?php /**PATH /Users/londo/Herd/test/resources/views/layouts/corporate.blade.php ENDPATH**/ ?>