...
<?php $component->withAttributes([]); ?>
  ...
  <div id="addModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden items-center justify-center z-50">
    <div class="bg-white rounded-lg p-6 max-w-md w-full mx-4">
      ...
      <form action="<?php echo e(route('app.settings.pallet-types.store')); ?>" method="POST">
        <?php echo csrf_field(); ?>
        <div class="space-y-4">
          <div>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/settings/pallet-types.blade.php ENDPATH**/ ?>