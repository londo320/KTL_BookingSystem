        ...
        <div class="user-list">
            ...
            <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="user-item">
                    ...
                    <div class="buttons">
                        <form method="GET" action="<?php echo e(route('app.test-email.preview')); ?>" style="display: inline;">
                            <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
                            <button type="submit" class="preview-btn">👁️ Preview Email</button>
                        </form>
                        <form method="POST" action="<?php echo e(route('app.test-email.send')); ?>" style="display: inline;">
                            <?php echo csrf_field(); ?>
                            <input type="hidden" name="user_id" value="<?php echo e($user->id); ?>">
...
</html><?php /**PATH /Users/londo/Herd/test/resources/views/test-email.blade.php ENDPATH**/ ?>