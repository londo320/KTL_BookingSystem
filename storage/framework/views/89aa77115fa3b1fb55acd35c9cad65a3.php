                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <select name="location_type" id="location_type" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-blue-500" required>
                                <option value="drop_zone" <?php echo e(old('location_type', $tippingLocation->location_type) == 'drop_zone' ? 'selected' : ''); ?>>Parking Area</option>
                                <option value="collection_zone" <?php echo e(old('location_type', $tippingLocation->location_type) == 'collection_zone' ? 'selected' : ''); ?>>Parking Area</option>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/tipping-locations/edit.blade.php ENDPATH**/ ?>