<?php $__env->startSection('title', 'Carrier Management'); ?>
...
<div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div class="p-6">
            ...
            <form method="GET" class="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                ...
                <div class="flex gap-2">
                    ...
                    <a href="<?php echo e(route('admin.carriers.index')); ?>" class="px-4 py-2 bg-gray-300 hover:bg-gray-400 text-gray-700 rounded-lg transition-colors">
                        Clear
                    </a>
                </div>
            </form>
    ...
    <div class="bg-white rounded-lg shadow-sm border mb-8">
        <div class="p-4">
            <form id="bulk-form" method="POST" action="<?php echo e(route('admin.carriers.bulk-action')); ?>">
                <?php echo csrf_field(); ?>
                <div class="flex items-center justify-between">
                    ...
                    <div class="flex gap-2">
                        <button type="button" onclick="window.location.href='<?php echo e(route('admin.carriers.cleanup')); ?>'"
                        ...
                        <tr class="hover:bg-gray-50 <?php echo e($carrier->trashed() ? 'bg-red-50' : ($carrier->is_active ? '' : 'bg-gray-50')); ?>">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-center">
                                <div class="flex items-center justify-center gap-2">
                                    <a href="<?php echo e(route('admin.carriers.show', $carrier)); ?>" 
                                    ...
                                    <?php if(!$carrier->trashed()): ?>
                                        <a href="<?php echo e(route('admin.carriers.edit', $carrier)); ?>" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/carriers/index.blade.php ENDPATH**/ ?>