...
<?php $component->withAttributes([]); ?>
    ...
    <div class="py-6 max-w-4xl mx-auto space-y-6">
        ...
        <?php endif; ?>
        <form method="POST" action="<?php echo e(route('app.settings.store')); ?>">
            <?php echo csrf_field(); ?>
            <div class="mb-4">
                <label for="depot_id" class="block font-medium"><?php echo e(__('Select Depot')); ?></label>
                <select id="depot_id" name="depot_id" class="border rounded w-full p-2">
                    <option value=""><?php echo e(__('— choose one —')); ?></option>
...
<?php endif; ?>
<?php /**PATH /Users/londo/Herd/test/resources/views/warehouse/settings.blade.php ENDPATH**/ ?>