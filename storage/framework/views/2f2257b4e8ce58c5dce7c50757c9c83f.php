...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex space-x-2">
                ...
                <a href="<?php echo e(route('admin.customer-behavior.show', $customer)); ?>" 
    ...
    <div class="py-6 max-w-4xl mx-auto">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            ...
            <form method="POST" action="<?php echo e(route('admin.customer-behavior.update-settings', $customer)); ?>" class="p-6">
                <?php echo csrf_field(); ?>
                ...
                <div class="flex items-center justify-between pt-8 border-t border-gray-200">
                    <button type="button" 
                            onclick="if(confirm('Reset all settings to default values?')) { window.location.href='<?php echo e(route('admin.customer-behavior.reset-settings', $customer)); ?>'; }"
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/customer-behavior/settings.blade.php ENDPATH**/ ?>