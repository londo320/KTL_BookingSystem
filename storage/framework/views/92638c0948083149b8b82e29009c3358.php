...
<?php $component->withAttributes([]); ?>
      ...
      <div class="flex items-center space-x-4">
        ...
        <div class="text-sm">
          <span class="font-mono bg-green-100 text-green-800 px-2 py-1 rounded">
            <?php echo e(now()->format('H:i:s')); ?> | Efficiency: <?php echo e($stats['efficiency_score']); ?>%
          </span>
        </div>
  ...
  <div class="py-6 max-w-full mx-auto px-4">
    ...
    <div class="grid grid-cols-2 md:grid-cols-6 gap-4 mb-6">
      <div class="bg-white p-4 rounded-lg shadow text-center">
        <div class="text-2xl font-bold text-blue-600"><?php echo e($stats['total_on_site']); ?></div>
      ...
      <div class="bg-white p-4 rounded-lg shadow text-center">
        <div class="text-2xl font-bold text-purple-600"><?php echo e($stats['empty_waiting_collection']); ?></div>
        <div class="text-xs text-purple-600">Awaiting Collection</div>
      </div>
      <div class="bg-white p-4 rounded-lg shadow text-center">
        <div class="text-2xl font-bold text-gray-600"><?php echo e($stats['average_wait_time']); ?>m</div>
        <div class="text-xs text-gray-600">Avg Wait Time</div>
      </div>
      <div class="bg-white p-4 rounded-lg shadow text-center">
        <div class="text-2xl font-bold <?php echo e($stats['efficiency_score'] > 80 ? 'text-green-600' : ($stats['efficiency_score'] > 60 ? 'text-yellow-600' : 'text-red-600')); ?>">
          <?php echo e($stats['efficiency_score']); ?>%
        </div>
          ...
          <div class="overflow-x-auto">
            <table class="min-w-full divide-y divide-gray-200">
              ...
              <tbody class="bg-white divide-y divide-gray-200">
                <?php $__currentLoopData = $tippingQueue->take(15); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php 
                ...
                ?>
                <tr class="hover:bg-blue-50 <?php echo e($priorityColor); ?>">
                  <td class="px-4 py-4 whitespace-nowrap">
                    <div class="flex items-center">
                      <span class="w-6 h-6 rounded-full text-xs font-bold flex items-center justify-center
                        <?php echo e($index < 3 ? 'bg-red-500 text-white' : ($index < 6 ? 'bg-orange-500 text-white' : 'bg-gray-400 text-white')); ?>">
                        <?php echo e($index + 1); ?>
                  ...
                  <td class="px-4 py-4 whitespace-nowrap">
                    <div class="font-medium text-blue-600"><?php echo e($booking->booking_reference); ?></div>
                    <div class="text-xs text-gray-500"><?php echo e($booking->vehicle_registration); ?></div>
                  </td>
                  <td class="px-4 py-4 whitespace-nowrap">
                    <div class="font-medium text-gray-900"><?php echo e($booking->container_number ?: 'Not specified'); ?></div>
                    <div class="text-xs text-gray-500">Container/Trailer #</div>
                  </td>
                  <td class="px-4 py-4 whitespace-nowrap">
                    <div class="text-sm text-gray-900"><?php echo e($booking->customer->name ?? 'Unknown'); ?></div>
                    <?php if($booking->poNumbers && $booking->poNumbers->count() > 0): ?>
                      <div class="text-xs text-blue-600">📦 <?php echo e($booking->poNumbers->count()); ?> PO(s)</div>
                    <?php endif; ?>
                  </td>
                  <?php if(!$currentDepotId): ?>
                    <td class="px-4 py-4 whitespace-nowrap">
                      <div class="text-sm text-gray-900"><?php echo e($booking->slot->depot->name ?? 'Unknown'); ?></div>
                    </td>
                  <?php endif; ?>
                  <td class="px-4 py-4 whitespace-nowrap">
                    <?php if($movement->tippingLocation): ?>
                      <div class="text-sm text-yellow-700"><?php echo e($movement->tippingLocation->name); ?></div>
                    <?php else: ?>
                    ...
                    <?php if($tippingType): ?>
                      <div class="flex flex-col items-center">
                        <div class="flex items-center space-x-1 mb-1">
                          <span class="text-lg"><?php echo e($config['icon']); ?></span>
                          <span class="text-xs"><?php echo e($config['priority']); ?></span>
                        </div>
                        <span class="px-2 py-1 text-xs rounded-full <?php echo e($config['color']); ?>">
                          <?php echo e($config['label']); ?>

                        </span>
                        <?php if($tippingType === 'live_tip'): ?>
                          <div class="text-xs text-blue-600 mt-1 font-medium">Priority</div>
                        <?php elseif($tippingType === 'drop'): ?>
                          <div class="text-xs text-green-600 mt-1">By Slot Time</div>
                        <?php endif; ?>
                      </div>
                    <?php else: ?>
                      <select onchange="setTippingType(<?php echo e($booking->id); ?>, this.value)" 
                  ...
                  <td class="px-4 py-4 whitespace-nowrap">
                    <div class="text-sm font-mono <?php echo e($waitMinutes > 120 ? 'text-red-600 font-bold' : 'text-gray-900'); ?>">
                      <?php echo e(round($waitMinutes/60, 1)); ?>h
                    </div>
                  </td>
                  <td class="px-4 py-4 whitespace-nowrap priority-details">
                    <div class="text-center">
                      <div class="text-lg font-bold <?php echo e($index < 3 ? 'text-red-600' : ($index < 6 ? 'text-orange-600' : 'text-gray-700')); ?>" 
                           title="Queue Position: #<?php echo e($index + 1); ?>">
                        <?php echo e($movement->efficiency_priority ?? 0); ?>
                  ...
                  <td class="px-4 py-4 whitespace-nowrap priority-details">
                    <div class="text-xs">
                      <?php $__currentLoopData = $movement->priority_reasons; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $reason): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <span class="inline-block px-2 py-1 bg-blue-100 text-blue-800 rounded-full mr-1 mb-1"><?php echo e($reason); ?></span>
                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                  </td>
                  <td class="px-4 py-4 whitespace-nowrap">
                    <div class="flex flex-col space-y-1">
                      ...
                      <?php if($isLiveTip): ?>
                        ...
                        <?php if($currentStatus === 'in_parking'): ?>
                          <button onclick="shuntToBay(<?php echo e($booking->id); ?>)" 
                                  class="px-3 py-1 bg-blue-500 text-white text-xs rounded hover:bg-blue-600">
                            🚛📦 Move to Bay
                          </button>
                        <?php elseif($currentStatus === 'at_bay'): ?>
                          <button onclick="startTipping(<?php echo e($booking->id); ?>)" 
                                  class="px-3 py-1 bg-green-500 text-white text-xs rounded hover:bg-green-600">
                            📦 Start Tipping
                          </button>
                        <?php elseif($currentStatus === 'unloading'): ?>
                          <button onclick="completeTipping(<?php echo e($booking->id); ?>)" 
                                  class="px-3 py-1 bg-orange-500 text-white text-xs rounded hover:bg-orange-600">
                            ✅ Complete Tipping
                          </button>
                        <?php else: ?>
                          <div class="text-xs text-gray-500">Status: <?php echo e($currentStatus); ?></div>
                        <?php endif; ?>
                      <?php elseif($isDrop): ?>
                        
                        <?php if(in_array($currentStatus, ['in_parking', 'at_bay'])): ?>
                          <button onclick="startTipping(<?php echo e($booking->id); ?>)" 
                                  class="px-3 py-1 bg-green-500 text-white text-xs rounded hover:bg-green-600">
                            📦 Start Tipping
                          </button>
                      ...
                      <select onchange="quickPriorityBoost(<?php echo e($booking->id); ?>, this.value)" 
                              class="px-1 py-1 text-xs border border-gray-300 rounded">
                        <option value="0" <?php echo e(($booking->manual_priority_boost ?? 0) == 0 ? 'selected' : ''); ?>>Normal</option>
                        <option value="50" <?php echo e(($booking->manual_priority_boost ?? 0) == 50 ? 'selected' : ''); ?>>+50 High</option>
                        <option value="100" <?php echo e(($booking->manual_priority_boost ?? 0) == 100 ? 'selected' : ''); ?>>+100 Urgent</option>
                        <option value="200" <?php echo e(($booking->manual_priority_boost ?? 0) == 200 ? 'selected' : ''); ?>>+200 Emergency</option>
                        <option value="-25" <?php echo e(($booking->manual_priority_boost ?? 0) == -25 ? 'selected' : ''); ?>>-25 Delay</option>
                      </select>
                    </div>
                  </td>
                </tr>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                <?php if($tippingQueue->count() == 0): ?>
                <tr>
                  <td colspan="<?php echo e(!$currentDepotId ? '11' : '10'); ?>" class="px-4 py-8 text-center text-gray-500">
      ...
      <div class="space-y-6" id="right-panel">
        ...
        <div class="bg-white rounded-lg shadow bay-status-section">
          ...
          <div class="p-4 space-y-3">
            <?php $__currentLoopData = $bayStatus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $bay): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="border border-gray-200 rounded p-3 bay-card <?php echo e($bay['status'] === 'available' ? 'bay-available' : 'bay-in-use'); ?>">
              <div class="flex items-center justify-between mb-2">
                <div class="font-medium"><?php echo e($bay['bay']->name); ?></div>
                <div>
                  <?php if($bay['status'] === 'available'): ?>
                    <span class="px-2 py-1 text-xs bg-green-100 text-green-800 rounded">Available Now</span>
                  <?php elseif($bay['status'] === 'unloading'): ?>
              ...
              <?php if($bay['current_booking']): ?>
                <div class="mt-2">
                  <div class="flex items-center justify-between mb-1">
                    <a href="<?php echo e(route('app.bookings.show', $bay['current_booking'])); ?>" 
                       class="text-sm font-medium text-blue-600 hover:text-blue-800 hover:underline">
                      <?php echo e($bay['current_booking']->booking_reference); ?>

                    </a>
                    <a href="<?php echo e(route('app.tipping-workflow.show', $bay['current_booking'])); ?>" 
                       class="px-2 py-1 bg-orange-500 text-white text-xs rounded hover:bg-orange-600 flex items-center">
                      ⚡ Workflow
                    </a>
                  </div>
                  <div class="text-xs text-gray-600 mb-1">
                    📦 <?php echo e($bay['current_booking']->container_number ?: 'No container #'); ?> • <?php echo e($bay['current_booking']->customer->name ?? 'Unknown'); ?>

                  </div>
                  <div class="text-xs text-gray-500">
                    Est. free: <?php echo e($bay['estimated_free_at']->format('H:i')); ?>

                    <?php if($bay['estimated_duration_remaining'] > 0): ?>
                      (<?php echo e($bay['estimated_duration_remaining']); ?>m remaining)
                    <?php endif; ?>
                  </div>
                </div>
              <?php endif; ?>
        ...
        <div class="bg-white rounded-lg shadow collection-urgency-section">
          ...
          <div class="p-4 space-y-2">
            <?php $__currentLoopData = $collectionUrgency->take(5); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php 
              $urgencyColors = [
            ...
            <div class="border border-gray-200 rounded p-2">
              <div class="flex items-center justify-between">
                <div class="text-sm font-medium"><?php echo e($movement->booking->booking_reference); ?></div>
                <span class="px-2 py-1 text-xs rounded <?php echo e($urgencyColors[$movement->collection_urgency]); ?>">
                  <?php echo e(round($movement->hours_waiting_collection, 1)); ?>h
                </span>
              </div>
              <div class="text-xs text-gray-500"><?php echo e($movement->booking->customer->name ?? 'Unknown'); ?></div>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            <?php if($collectionUrgency->count() == 0): ?>
        ...
        <div class="bg-white rounded-lg shadow">
          ...
          <div class="p-4 space-y-2">
            <?php $__currentLoopData = $newArrivals->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $movement): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="border border-gray-200 rounded p-2">
              <div class="text-sm font-medium"><?php echo e($movement->booking->booking_reference); ?></div>
              <div class="text-xs text-gray-500"><?php echo e($movement->booking->customer->name ?? 'Unknown'); ?></div>
              <button onclick="assignParkingArea(<?php echo e($movement->booking->id); ?>)" 
  ...
  <script>
    ...
    function openPrioritySettings() {
      ...
      let settingsUrl = '<?php echo e(route("admin.operations.priority-settings")); ?>';
      if (depotId) {
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/operations/queue-management.blade.php ENDPATH**/ ?>