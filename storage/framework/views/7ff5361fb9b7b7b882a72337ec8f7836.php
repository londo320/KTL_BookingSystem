...
<?php $component->withAttributes([]); ?>
     ...
     <?php $__env->slot('header', null, []); ?> 
        <div class="flex items-center justify-between">
            ...
            <div class="flex items-center space-x-3">
                ...
                <a href="<?php echo e(route($routePrefix . 'depot-map.manage-positions')); ?>?depot_id=<?php echo e($depot->id); ?>" class="px-3 py-1 bg-green-600 text-white rounded hover:bg-green-700 text-sm">
                    🎯 Position Bays
                </a>
            ...
            <div class="space-y-6">
                ...
                <div class="bg-white rounded-lg shadow">
                    ...
                    <div class="p-4 space-y-3">
                        ...
                        <a href="<?php echo e(route('admin.trailer-location-report')); ?>" class="block w-full px-3 py-2 bg-purple-600 text-white rounded text-sm hover:bg-purple-700 text-center">
                            📍 Location Report
                        </a>
                    </div>
                </div>
    ...
    <script>
        ...
        async function refreshMapData() {
            try {
                const response = await fetch('<?php echo e(route("admin.depot-map.refresh")); ?>', {
                    method: 'POST',
                    headers: {
        ...
        async function changeBay(currentBayId, bookingId) {
            ...
            if (confirm('Are you sure you want to move this vehicle to the selected bay?')) {
                try {
                    const response = await fetch('<?php echo e(route("admin.depot-map.change-bay")); ?>', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json',
                            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').getAttribute('content')
        ...
        function showAllBookings() {
            window.location.href = '<?php echo e(route("admin.bookings.index")); ?>';
        }
        
        function openTrailerCollection() {
            window.open('<?php echo e(route("admin.empty-unit-collection")); ?>', '_blank', 'width=1200,height=800');
        }
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/depot-map/index.blade.php ENDPATH**/ ?>