<?php $__env->startSection('title', $carrier->name . ' - Carrier Details'); ?>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-lg shadow-sm border">
                ...
                <div class="p-4 space-y-3">
                    <?php if($carrier->trashed()): ?>
                        <form action="<?php echo e(route('admin.carriers.restore', $carrier->id)); ?>" method="POST">
                            <?php echo csrf_field(); ?>
                            <button type="submit" 
                    ...
                    <?php else: ?>
                        ...
                        <form action="<?php echo e(route('admin.carriers.destroy', $carrier)); ?>" method="POST" 
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/carriers/show.blade.php ENDPATH**/ ?>