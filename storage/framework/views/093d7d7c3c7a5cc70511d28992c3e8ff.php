          ...
          <tbody class="bg-white divide-y divide-gray-200">
            ...
            <tr class="hover:bg-gray-50 <?php echo e($data['workflow_priority'] <= 2 ? 'bg-red-50' : ''); ?>">
              ...
              <td class="px-4 py-4 whitespace-nowrap text-sm font-medium text-blue-600">
                ...
                <?php if($booking->booked_at): ?>
                  <br><span class="text-xs text-gray-500"><?php echo e($booking->booked_at->format('M j H:i')); ?></span>
                <?php endif; ?>
              </td>
              ...
              <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-900">
                ...
                <?php if($booking->poNumbers && $booking->poNumbers->count() > 0): ?>
                  <br><span class="text-xs text-blue-600">📦 <?php echo e($booking->poNumbers->pluck('po_number')->join(', ')); ?></span>
                <?php endif; ?>
              </td>
              ...
              <td class="px-4 py-4 whitespace-nowrap text-sm text-gray-600">
                ...
                <?php if($booking->container_number): ?>
                  <br><span class="text-xs font-mono"><?php echo e($booking->container_number); ?></span>
                <?php endif; ?>
              </td>
...
<?php endif; ?><?php /**PATH /Users/londo/Herd/test/resources/views/admin/bookings/trailer-operations-dashboard.blade.php ENDPATH**/ ?>