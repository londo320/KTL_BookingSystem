...
<head>
  ...
  <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@300;400;600&display=swap" rel="stylesheet">
    <!-- Favicon -->
  <link rel="icon" type="image/svg+xml" href="<?php echo e(asset('images/ktl.svg')); ?>" />
  <script>
    tailwind.config = {
      theme: {
        extend: {
  ...
  <div class="bg-white/60 backdrop-blur-lg rounded-2xl shadow-2xl p-8 sm:p-10 md:p-12 w-full max-w-md animate-[popIn_0.4s_ease-out_both]">
    ...
    <form method="POST" action="<?php echo e(route('login')); ?>" novalidate>
      ...
      <div class="flex items-center justify-between mb-6">
        ...
        <a href="<?php echo e(route('password.request')); ?>" class="text-sm text-ktl-red hover:underline">
    ...
    <div class="mt-4 text-center">
      ...
      <a href="<?php echo e(route('register')); ?>" class="ml-1 text-ktl-red font-semibold hover:underline">
        Register
      </a>
    </div>
...
<?php /**PATH /Users/londo/Herd/test/resources/views/auth/login.blade.php ENDPATH**/ ?>